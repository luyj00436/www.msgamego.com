    ...
    <?php endif; ?>
        ...
        <div id="message" class="updated notice is-dismissible">
            ...
            <?php if ($wp_http_referer && false === strpos($wp_http_referer, 'user-new.php') && !IS_PROFILE_PAGE) : ?>
                <p>
                    <a href="<?php echo esc_url(wp_validate_redirect(sanitize_url($wp_http_referer), self_admin_url('users.php'))); ?>"><?php _e('&larr; Go to Users'); ?></a>
                </p>
            <?php endif; ?>
        </div>
    <?php endif; ?>
                ...
                <table class="form-table" role="presentation">
                    <tr class="user-user-login-wrap">
                        ...
                        <td><input type="text" name="user_login" id="user_login"
                                   value="<?php echo esc_attr($profile_user->user_login); ?>" disabled="disabled"
                    ...
                    <tr class="user-pass2-wrap hide-if-js">
                        ...
                        <td>
                            <input name="pass2" type="password" id="pass2" class="regular-text" value=""
                                   autocomplete="new-password" aria-describedby="pass2-desc"/>
                            <?php if (IS_PROFILE_PAGE) : ?>
