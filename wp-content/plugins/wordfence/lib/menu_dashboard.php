                                            ...
                                            <?php elseif (wfConfig::get('keyType') == wfLicense::KEY_TYPE_FREE || wfConfig::get('keyType') === false): ?>
                                                <div>
                                                    ...
                                                    <p><a class="wf-btn wf-btn-primary wf-btn-callout-subtle"
                                                          href="https://www.wordfence.com/gnl1dashboardUpgrade/products/wordfence-premium/"
                                                          target="_blank"
                                                          rel="noopener noreferrer"><?php esc_html_e('Upgrade to Premium', 'wordfence'); ?></a>&nbsp;&nbsp;<a
                                                                class="wf-btn wf-btn-callout-subtle wf-btn-default"
                                                                href="https://www.wordfence.com/gnl1dashboardLearn/products/pricing/"
                                                                target="_blank"
                                            ...
                                            <?php elseif (wfLicense::current()->isPaidAndCurrent()): ?>
                                                <div class="wf-block-labeled-value wf-protection-status wf-protection-status-<?php echo esc_attr($firewall->ruleMode()); ?>">
                                                    <div class="wf-block-labeled-value-value"><i
                                                                class="wf-fa wf-fa-check" aria-hidden="true"></i></div>
