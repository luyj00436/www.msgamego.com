    ...
    foreach ($issues as $i) {
        if ($i['severity'] == $severityLevel) { ?>
            ...
            if (!empty($i['tmplData']['badURL'])):
                ...
                ?>
                <p><img src="<?php echo esc_url($url) ?>"
                        alt="<?php esc_html_e('The malicious URL matched', 'wordfence') ?>"/></p>
            <?php endif ?>
...
<?php if (!$isPaid) { ?>
    ...
    <p><?php esc_html_e('Click here to upgrade to Wordfence Premium:', 'wordfence'); ?><br><a
                href="https://www.wordfence.com/zz2/wordfence-signup/">https://www.wordfence.com/zz2/wordfence-signup/</a>
    </p>
<?php } ?>
