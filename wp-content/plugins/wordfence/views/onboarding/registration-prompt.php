...
<div class="wf-onboarding-registration-prompt">
    ...
    <div class="wf-onboarding-install-new wf-onboarding-install-type"<?php if ($existing): ?> style="display: none;"<?php endif ?>>
        <div>
            <a class="wf-btn wf-btn-primary wf-onboardng-register"
               href="<?php esc_attr_e($registrationLink) ?>"><?php esc_html_e('Get Your Wordfence License', 'wordfence') ?></a>
        </div>
        <div>
            <a class="wf-onboarding-install-type-toggle"
               href="#"><?php esc_html_e('Install an existing license', 'wordfence') ?></a>
        </div>
    </div>
    <div class="wf-onboarding-install-existing wf-onboarding-install-type"
         data-attempt="<?php echo esc_attr($attempt) ?>"
    ...
    >
        <form class="wf-onboarding-form">
            <div class="wf-onboarding-form-group">
                ...
                <input id="wf-onboarding-email-input" type="email" value="<?php echo esc_attr((string)$email) ?>"
                       pattern="^[^@\s]+@[^@\s]+\.[^@\s]+$"
                       title="<?php esc_html_e('Please enter a valid email address', 'wordfence') ?>" required>
            ...
            <div class="wf-onboarding-form-group">
                ...
                <textarea id="wf-onboarding-license-input" rows="3"
                          required><?php echo esc_html((string)$license) ?></textarea>
            </div>
            ...
            <div class="wf-onboarding-form-group wf-onboarding-consent-group"<?php if ($populated): ?> style="display: none;"<?php endif ?>>
                <input type="checkbox" id="wf-onboarding-consent-input"
                       required<?php if ($populated): ?> checked<?php endif ?>>
                <label for="wf-onboarding-consent-input">I have read and agree to the <a
                            href="https://www.wordfence.com/license-terms-and-conditions/" target="_blank"
                            rel="noopener noreferrer">Wordfence License Terms and Conditions</a>, the <a
                            href="https://www.wordfence.com/services-subscription-agreement" rel="noopener noreferrer"
                            target="_blank">Services Subscription Agreement</a>, and <a
                            href="https://www.wordfence.com/terms-of-service/" target="_blank"
                            rel="noopener noreferrer">Terms of Service</a>, and have read and acknowledge the <a
                            href="https://www.wordfence.com/privacy-policy/" target="_blank" rel="noopener noreferrer">Wordfence
                        Privacy Policy</a>.</label>
            </div>
            <button class="wf-btn wf-btn-primary wf-onboarding-install-license"
                    type="submit"><?php esc_html_e('Install License', 'wordfence') ?></button>
        </form>
        <?php if (!$populated): ?>
            <div>
                <a class="wf-onboarding-link"
                   href="<?php esc_attr_e($registrationLink) ?>"><?php esc_html_e('Get a new license', 'wordfence') ?></a>
            </div>
        <?php endif ?>
    </div>
</div>
<div style="display: none;">
    ...
    <?php foreach ($licenseTypeModals as $key => $modal): ?>
        <div class="wf-modal wf-modal-success"
             id="<?php echo esc_attr("wf-onboarding-registration-success-$key-template") ?>">
            ...
            <div class="wf-modal-footer">
                <ul class="wf-onboarding-flex-horizontal wf-onboarding-flex-align-right wf-onboarding-full-width">
                    <li><a href="<?php echo esc_url(network_admin_url('admin.php?page=Wordfence')); ?>"
                           class="wf-onboarding-btn wf-onboarding-btn-primary"><?php esc_html_e('Go To Dashboard', 'wordfence'); ?></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="wf-modal" id="wf-onboarding-registration-error-template">
        <div class="wf-modal-header">
            <div class="wf-modal-header-content">
                <div class="wf-modal-title">
                    <strong><?php esc_html_e('Error Installing License', 'wordfence') ?></strong></div>
            </div>
        </div>
        ...
        <div class="wf-modal-footer">
            <ul class="wf-onboarding-flex-horizontal wf-onboarding-flex-align-right wf-onboarding-full-width">
                <li><a href="#" class="wf-onboarding-btn wf-onboarding-btn-primary"
                       onclick="jQuery.wfcolorbox.close(); return false;" role="button">Close</a></li>
            </ul>
        </div>
    </div>
</div>