...
<?php elseif ($state == 'prompt'): ?>
    ...
    <form method="POST"
          action="<?php echo esc_attr(wfUtils::getSiteBaseURL() . '?_wfsf=removeAlertEmail&jwt=' . $jwt); ?>">
...
<p style="color: #999999;margin-top: 2rem;">
    <em><?php esc_html_e('Generated by Wordfence at ', 'wordfence'); ?><?php echo gmdate('D, j M Y G:i:s T', wfWAFUtils::normalizedTime()); ?>
