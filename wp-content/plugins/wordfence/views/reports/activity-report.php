 ...
 */
?>
    <a class="wf-logo" href="//www.wordfence.com/zz8/"><img
                src="<?php echo wfUtils::getBaseURL(); ?>images/wf-horizontal.svg" alt="Wordfence"/></a>
...
<?php wfHelperString::cycle(); ?>
                ...
                <tr class="<?php echo wfHelperString::cycle('odd', 'even') ?>">
                    ...
                    <td>
                        <?php if ($row->countryCode): ?>
                            <span class="wf-flag <?php echo esc_attr('wf-flag-' . strtolower($row->countryCode)); ?>"
                                  title="<?php echo esc_attr($row->countryName); ?>"></span>
                            &nbsp;
    ...
    <p>
        <a class="button button-primary"
           href="<?php echo wfUtils::wpAdminURL('admin.php?page=WordfenceWAF#top#blocking') ?>"><?php esc_html_e('Update Blocked IPs', 'wordfence'); ?></a>
    </p>
...
<?php wfHelperString::cycle(); ?>
    ...
    <p>
        <a class="button button-primary"
           href="<?php echo wfUtils::wpAdminURL('admin.php?page=WordfenceWAF#top#blocking') ?>"><?php esc_html_e('Update Blocked Countries', 'wordfence'); ?></a>
    </p>
...
<?php wfHelperString::cycle(); ?>
    ...
    <p>
        <a class="button button-primary"
           href="<?php echo wfUtils::wpAdminURL('admin.php?page=WordfenceWAF&subpage=waf_options#waf-options-bruteforce') ?>"><?php esc_html_e('Update Login Security Options', 'wordfence'); ?></a>
    </p>
...
<?php if ($updates_needed['core'] || $updates_needed['plugins'] || $updates_needed['themes']): ?>
    <p><a class="button button-primary"
          href="<?php echo esc_attr(wfUtils::wpAdminURL('update-core.php')) ?>"><?php esc_html_e('Update Now', 'wordfence'); ?></a>
    </p>
<?php else: ?>
