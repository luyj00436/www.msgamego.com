...
<div style="display: none;">
    <div class="wf-modal wf-deactivate-modal" id="wf-offboarding-delete-prompt-template">
        <div class="wf-modal-header">
            <div class="wf-modal-header-content">
                <div class="wf-modal-title"><strong><?php esc_html_e('Deactivate Wordfence', 'wordfence') ?></strong>
                </div>
            </div>
        </div>
            ...
            <div class="wf-radio-group">
                <?php foreach (wfDeactivationOption::getAll() as $option): ?>
                    ...
                    <div class="wf-radio-option">
                        <input type="radio" data-name="wf-deactivate-option"
                               value="<?php echo esc_attr($option->getKey()) ?>" class="wf-templated"
                               data-id="<?php echo esc_attr($inputId) ?>"<?php if ($option->getKey() === $selectedOptionKey): ?> checked<?php endif ?>>
        ...
        <div class="wf-modal-footer">
            <button data-id="wf-deactivate-delete"
                    class="wf-btn wf-btn-danger wf-deactivate-confirm wf-templated"><?php esc_html_e('Deactivate and Delete Data', 'wordfence') ?></button>
            <button data-id="wf-deactivate-retain"
                    class="wf-btn wf-btn-primary wf-deactivate-confirm wf-templated"><?php esc_html_e('Deactivate', 'wordfence') ?></button>
            <button data-id="wf-deactivate-cancel"
                    class="wf-btn wf-btn-default wf-templated"><?php esc_html_e('Cancel', 'wordfence') ?></button>
        </div>
    </div>
    <?php if ($wafOptimized): ?>
            ...
            <div class="wf-modal-header">
                <div class="wf-modal-header-content">
                    <div class="wf-modal-title">
                        <strong><?php esc_html_e('Extended Protection Still Enabled', 'wordfence') ?></strong></div>
                </div>
            </div>
            <div class="wf-modal-content">
                ...
                <p>
                    <a href="<?php echo wfSupportController::esc_supportURL(wfSupportController::ITEM_FIREWALL_REMOVE_OPTIMIZATION) ?>"
                       target="_blank" rel="noopener noreferrer"><?php esc_html_e('Learn More', 'wordfence') ?></a></p>
            </div>
            <div class="wf-modal-footer">
                <a class="wf-btn wf-btn-danger"
                   href="<?php echo esc_attr(network_admin_url('admin.php?page=WordfenceWAF&subpage=waf_options&wf_deactivate=true#removeAutoPrepend')) ?>"><?php esc_html_e('Remove Extended Protection', 'wordfence') ?></a>
                <button onclick="jQuery.wfcolorbox.close(); return false;"
                        class="wf-btn wf-btn-default"><?php esc_html_e('Cancel', 'wordfence') ?></a>
            </div>
        </div>
    <?php endif ?>
    <div class="wf-modal" id="wf-offboarding-delete-confirm-template">
        <div class="wf-modal-header">
            <div class="wf-modal-header-content">
                <div class="wf-modal-title"><strong><?php esc_html_e('Delete Wordfence Data?', 'wordfence') ?></strong>
                </div>
            </div>
        </div>
        <div class="wf-modal-content"><span
                    class="message"><?php esc_html_e('Are you sure you want to delete the selected Wordfence data? If you reactivate Wordfence later, deleted settings and history cannot be recovered.', 'wordfence') ?></span>
        </div>
        <div class="wf-modal-footer">
    ...
    <div class="wf-modal" id="wf-offboarding-delete-error-template">
        ...
        <div class="wf-modal-content"><span
                    class="message"><?php esc_html_e('An unexpected error occurred while attempting to configure Wordfence to delete its data on deactivation.', 'wordfence') ?></span>
        </div>
        <div class="wf-modal-footer wf-modal-footer-center">
            <button onclick="jQuery.wfcolorbox.close(); return false;"
                    class="wf-btn wf-btn-primary"><?php esc_html_e('Close', 'wordfence') ?></a>
        </div>
    </div>
</div>
