                    ...
                    <li>
                        <ul class="wf-flex-vertical wf-flex-align-left">
                            ...
                            <li class="wf-option-howgetips-details wf-padding-add-top-small">
                                ...
                                <div class="wf-left"><?php esc_html_e('Your IP with this setting:', 'wordfence') ?><span
                                            id="howGetIPs-preview-single"><?php echo wfUtils::getIP(); ?></span></div>
                ...
                <ul>
                    ...
                    <li class="wf-option-textarea">
                        <textarea spellcheck="false" autocapitalize="none" autocomplete="off"
                                  name="howGetIPs_trusted_proxies"><?php echo esc_html(wfConfig::get('howGetIPs_trusted_proxies')); ?></textarea>
                    </li>
                </ul>
            </li>
        </ul>
