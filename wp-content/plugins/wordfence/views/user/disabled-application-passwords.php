    ...
    <tr>
        ...
        <td>
            ...
            <?php if ($isAdmin): ?>
                ...
                ?>
                <p>
                    <a href="<?php echo esc_attr(is_multisite() ? network_admin_url($optionsUrl) : admin_url($optionsUrl)) ?>"
                       class="button"><?php esc_html_e('Edit Wordfence Options', 'wordfence') ?></a></p>
            <?php endif ?>
        </td>
    </tr>
</table>