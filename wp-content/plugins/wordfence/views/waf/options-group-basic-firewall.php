                    ...
                    <ul class="wf-block-list wf-block-list-horizontal">
                        <li id="wf-option-wafStatus" class="wf-flex-vertical wf-flex-align-left wf-flex-full-width">
                            ...
                            <?php else: ?>
                                ...
                                <p class="wf-no-top wf-add-bottom">
                                    <select id="input-wafStatus"
                                            data-original-value="<?php echo esc_attr($wafStatus); ?>" name="wafStatus"
                                ...
                                <div id="waf-learning-mode-grace-period" class="wf-add-bottom" style="display: none;">
                                    ...
                                    <span> <?php esc_html_e('Automatically enable on', 'wordfence'); ?> </span><input
                                            type="text" name="learningModeGracePeriod"
                                            id="input-learningModeGracePeriod" class="wf-datetime wf-form-control"
                                            placeholder="Enabled until..." data-value="<?php try {
                        ...
                        <li id="wf-option-disableWAFBlacklistBlocking" class="wf-flex-vertical wf-flex-align-left">
                            ...
                            <?php else: ?>
                                ...
                                <div class="wf-option wf-option-switch wf-padding-add-bottom"
                                     data-option-name="disableWAFBlacklistBlocking" data-original-value="<?php try {
                                        ...
                                        foreach ($states as $s):
                                            ...
                                            <li<?php if ($s['value'] == ($disableBlacklist ? '1' : '0')) {
                                                echo ' class="wf-active"';
                                                 ...
                                                 aria-checked="<?php echo(($s['value'] == ($disableBlacklist ? '1' : '0')) ? 'true' : 'false'); ?>"
