        ...
        <li class="wf-issue-summary">
            <ul>
                ...
                <li class="wf-issue-short">
                    <p><strong><?php esc_html_e('Need help with a security issue?', 'wordfence'); ?></strong></p>
                    <?php if (wfLicense::current()->isBelowCare()): ?>
                        <p><?php esc_html_e('Sign up for Wordfence Care and we’ll take care of it. Our security experts will clean your site, resolve the infection, and perform a security audit. Get hands-on support with any security issue including help installing, configuring and optimizing Wordfence.', 'wordfence'); ?></p>
                    <?php endif ?>
                </li>
                <?php if (wfLicense::current()->isAtLeastCare()): ?>
                    <li class="wf-issue-controls"><a class="wf-btn wf-btn-primary wf-btn-callout-subtle"
                                                     href="<?php echo esc_attr(wfLicense::current()->getSupportUrl('scanGetHelp')) ?>"
                                                     target="_blank"
                ...
                <?php else: ?>
                    <li class="wf-issue-controls"><a class="wf-btn wf-btn-primary wf-btn-callout-subtle"
                                                     href="https://www.wordfence.com/gnl1scanGetHelp/products/wordfence-care/"
                                                     target="_blank"
