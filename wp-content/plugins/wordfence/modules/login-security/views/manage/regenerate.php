...
<div class="wfls-block wfls-always-active wfls-flex-item-full-width">
    ...
    <div class="wfls-block-content wfls-padding-add-bottom">
        ...
        <p class="wfls-center wfls-add-top"><a href="#" class="wfls-btn wfls-btn-default" id="wfls-recovery"
                                               target="_blank"
                                               rel="noopener noreferrer"><?php esc_html_e('Generate New Codes', 'wordfence-2fa'); ?></a>
        </p>
    </div>
</div>
