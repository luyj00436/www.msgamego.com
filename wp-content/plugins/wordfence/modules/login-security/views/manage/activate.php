...
<div class="wfls-block wfls-always-active wfls-flex-item-full-width">
    ...
    <div class="wfls-block-content wfls-padding-add-bottom">
        <p><?php esc_html_e('Download Recovery Codes', 'wordfence-2fa'); ?> <em
                    class="wfls-text-small"><?php esc_html_e('Optional', 'wordfence-2fa'); ?></em></p>
        ...
        <p class="wfls-center"><a href="#" class="wfls-btn wfls-btn-default" id="wfls-recovery-download" target="_blank"
                                  rel="noopener noreferrer"><i
                        class="dashicons dashicons-download"></i> <?php esc_html_e('Download', 'wordfence-2fa'); ?></a>
        </p>
        ...
        <p><input type="text" id="wfls-activate-field" value="" size="6" maxlength="6" placeholder="123456"
                  autocomplete="off"></p>
    </div>
    <div class="wfls-block-footer">
        <div class="wfls-block-footer-content">
            <div class="wfls-block-title" id="wfls-activation-help-link-container">
                <a href="<?php echo \WordfenceLS\Controller_Support::esc_supportURL(\WordfenceLS\Controller_Support::ITEM_MODULE_LOGIN_SECURITY_2FA); ?>"
                   target="_blank"
                   rel="noopener noreferrer"><?php esc_html_e('For help on setting up an app, visit our help article.', 'wordfence-2fa'); ?></a>
            </div>
            <div class="wfls-block-footer-action"><a href="#" id="wfls-activate"
                                                     class="wfls-btn wfls-btn-default wfls-disabled"><?php esc_html_e('Activate', 'wordfence-2fa'); ?></a>
            </div>
        </div>
    </div>
</div>
