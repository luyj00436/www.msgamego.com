...
<div id="wfls-management-embedded"<?php if ($stacked): ?> class="stacked" <?php endif ?>>
    ...
    <div id="wfls-deactivation-controls" class="<?php echo $containerClasses ?>"<?php if (!$enabled) {
    ...
    <div id="wfls-activation-controls"
         class="<?php echo $containerClasses ?><?php if (!$stacked): ?> wfls-no-bottom-column-margin<?php endif ?>"<?php if ($enabled) {
        echo ' style="display: none;"';
    } ?>>
        <?php
    ...
    <div id="wfls-grace-period-controls"
         class="<?php echo $containerClasses ?>"<?php if ($enabled || !($lockedOut || $inGracePeriod)) {
        echo ' style="display: none;"';
    } ?>>
