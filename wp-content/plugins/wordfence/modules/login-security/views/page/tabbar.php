    ...
    <div class="wfls-col-xs-12">
        ...
        <ul class="wfls-page-tabs">
            ...
            <?php foreach ($tabs as $t): ?>
                ...
                ?>
                <li class="wfls-tab" id="wfls-tab-<?php echo esc_attr($t->id); ?>"
                    data-target="<?php echo esc_attr($t->id); ?>"
                    data-page-title="<?php echo esc_attr($t->pageTitle); ?>"><a
                            href="<?php echo esc_url($a); ?>"><?php echo esc_html($t->tabTitle); ?></a></li>
            <?php endforeach; ?>
        </ul>
    </div>
</div>