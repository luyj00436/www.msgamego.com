    ...
    <?php if (!empty($requiredRoles)): ?>
        <li class="wfls-2fa-notification-action">
            ...
            <p>
                ...
                <a href="<?php echo \WordfenceLS\Controller_Support::esc_supportURL(\WordfenceLS\Controller_Support::ITEM_MODULE_LOGIN_SECURITY_2FA_NOTIFICATIONS) ?>"
                   target="_blank" rel="noopener noreferrer" class="wfls-inline-help"><i
                            class="<?php echo \WordfenceLS\Controller_WordfenceLS::shared()->should_use_core_font_awesome_styles() ? 'wf-fa wf-fa-question-circle-o' : 'wfls-fa wfls-fa-question-circle-o'; ?>"
            ...
            <button class="wfls-btn wfls-btn-default wfls-btn-sm"
                    id="wfls-send-grace-period-notification"><?php esc_html_e('Notify', 'wordfence-2fa') ?></button>
        </li>
    <?php endif ?>
</ul>
<script>
