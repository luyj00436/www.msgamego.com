...
<p><textarea id="payload" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"
             cols="65"><?php echo htmlspecialchars($payload); ?></textarea></p>
...
<p><a href="#" id="reportButton" class="btn disabled" target="_blank"
      rel="noopener noreferrer"><?php wfWAFI18n::esc_html_e('Report Problem') ?></a></p>
