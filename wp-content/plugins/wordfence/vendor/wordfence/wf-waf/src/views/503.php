...
<div class="container">
    ...
    if (!empty($siteURL) && !empty($nonce)) : ?>
        ...
        <form method="POST" id="unlock-form" action="#">
            ...
            <input type="text" size="50" name="email" id="unlock-email" value="" maxlength="255"
                   placeholder="email@example.com">&nbsp;&nbsp;<input type="submit" class="wf-btn wf-btn-default"
                                                                      id="unlock-submit" name="s"
                                                                      value="<?php echo htmlentities(wfWAFI18n::esc_html__('Send Unlock Email'), ENT_QUOTES, 'utf-8') ?>"
                                                                      disabled>
        </form>
