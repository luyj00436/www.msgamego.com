<div template-id="wpfc-modal-lazyload"
     style="top: 10.5px; left: 226px; position: absolute; padding: 6px; height: auto; width: 560px; z-index: 10001;display:none;">
    ...
    <div style="z-index: 600; border-radius: 3px;">
        <div style="font-family:Verdana,Geneva,Arial,Helvetica,sans-serif;font-size:12px;background: none repeat scroll 0px 0px rgb(255, 161, 0); z-index: 1000; position: relative; padding: 2px; border-bottom: 1px solid rgb(194, 122, 0); height: 35px; border-radius: 3px 3px 0px 0px;">
            <table width="100%" height="100%">
                ...
                <tr>
                    <td valign="middle"
                        style="vertical-align: middle; font-weight: bold; color: rgb(255, 255, 255); text-shadow: 0px 1px 1px rgba(0, 0, 0, 0.5); padding-left: 10px; font-size: 13px; cursor: move;"><?php _e("Lazy Load Settings", "wp-fastest-cache"); ?></td>
                    ...
                    <div wpfc-cdn-page="1" class="wiz-cont" style="">
                        ...
                        <div class="wiz-input-cont">
                            <label class="mc-input-label" style="margin-right: 5px;"><input
                                        type="radio" <?php echo $wpFastestCacheLazyLoad_type_all; ?>
                                        action-id="wpFastestCacheLazyLoad_type_all" id="wpFastestCacheLazyLoad_type_all"
                                        name="wpFastestCacheLazyLoad_type" value="all"></label>
                            <label for="wpFastestCacheLazyLoad_type_all">All Images</label>
                        </div>

                        <div class="wiz-input-cont" style="margin-top:10px !important;">
                            <label class="mc-input-label" style="margin-right: 5px;"><input
                                        type="radio" <?php echo $wpFastestCacheLazyLoad_type_exceptcontent; ?>
                                        action-id="wpFastestCacheLazyLoad_type_exceptcontent"
                                        id="wpFastestCacheLazyLoad_type_exceptcontent"
                                        name="wpFastestCacheLazyLoad_type" value="exceptcontent"></label>
                            <label for="wpFastestCacheLazyLoad_type_exceptcontent">All Images except images in
                                content</label>
                        </div>
