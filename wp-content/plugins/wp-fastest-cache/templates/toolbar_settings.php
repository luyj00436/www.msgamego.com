...
<div template-id="wpfc-modal-toolbarsettings"
    ...
    <div style="z-index: 600; border-radius: 3px;">
        <div style="font-family:Verdana,Geneva,Arial,Helvetica,sans-serif;font-size:12px;background: none repeat scroll 0px 0px rgb(255, 161, 0); z-index: 1000; position: relative; padding: 2px; border-bottom: 1px solid rgb(194, 122, 0); height: 35px; border-radius: 3px 3px 0px 0px;">
            <table width="100%" height="100%">
                ...
                <tr>
                    <td valign="middle"
                        style="vertical-align: middle; font-weight: bold; color: rgb(255, 255, 255); text-shadow: 0px 1px 1px rgba(0, 0, 0, 0.5); padding-left: 10px; font-size: 13px; cursor: move;"><?php _e('Toolbar Settings', 'wp-fastest-cache'); ?></td>
            ...
            <div class="window-content"
                ...
                <div class="wpfc-cdn-pages-container">
                    <div class="wiz-cont" style="">
                        <h1>Authorities</h1>
                        <p style="margin-bottom: 24px;">This feature allows you to show the clear cache button which
                            exists on the admin toolbar based on user roles. <a target="_blank"
                                                                                href="https://www.wpfastestcache.com/features/clear-cache-link-on-the-toolbar/"><img
                                        src="<?php echo plugins_url("wp-fastest-cache/images/info.png"); ?>"/></a></p>
                        ...
                        foreach ($wpfc_role_names as $key => $value) {
                            ...
                            <div class="wiz-input-cont"
                                 style="padding-right: 12px;margin-right: 10px;width: auto !important;">
                                <label class="mc-input-label" style="margin-right: 5px;"><input type="checkbox"
                                                                                                id="<?php echo $wpfc_toolbar_element_id; ?>"
                                                                                                name="<?php echo $wpfc_toolbar_element_id; ?>"></label>
