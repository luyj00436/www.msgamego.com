<div id="wpfc-modal-updatesuccess"
     style="top: 10.5px; left: 226px; position: absolute; padding: 6px; height: auto; width: 300px; z-index: 10001;">
    ...
    <div style="z-index: 600; border-radius: 3px;">
        <div style="font-family:Verdana,Geneva,Arial,Helvetica,sans-serif;font-size:12px;background: none repeat scroll 0px 0px rgb(255, 161, 0); z-index: 1000; position: relative; padding: 2px; border-bottom: 1px solid rgb(194, 122, 0); height: 35px; border-radius: 3px 3px 0px 0px;">
            <table width="100%" height="100%">
                ...
                <tr>
                    <td valign="middle"
                        style="vertical-align: middle; font-weight: bold; color: rgb(255, 255, 255); text-shadow: 0px 1px 1px rgba(0, 0, 0, 0.5); padding-left: 10px; font-size: 13px; cursor: move;"><?php _e("Success", "wp-fastest-cache"); ?></td>
        ...
        <div class="window-content-wrapper" style="padding: 15px;">
            <div class="window-content"
                ...
                <center style="color: black;">WP Fastest Cache Premium has been updated. Please <u>push</u> finish
                    button
                </center>
            </div>
        </div>
