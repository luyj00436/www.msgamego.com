...
<div class="wpfc-csp-item" tabindex="1" style="position: relative;display:none;">
    <div class="app">
        <div class="wpfc-csp-item-form-title">Specific Page - <span
                    style="color: green;">When Updating or Posting</span></div>
...
<div template-id="wpfc-modal-csp"
            ...
            <div style="z-index: 1000; height: auto; position: relative; display: inline-block; width: 100%;"
                ...
                <div id="wpfc-wizard-csp" class="wpfc-cdn-pages-container">
                    <div wpfc-cdn-page="1" class="wiz-cont">
                        ...
                        <h1>Enter a Url</h1>
                        <p>Please enter a url which you want cleared from cache whenever a post is created or
                            updated.</p>
                        <div class="wiz-input-cont">
                            <input placeholder="<?php echo get_site_url('', 'sample-page'); ?>" type="text" name="url"
                                   class="api-key" style="width: 100%;">
                            <label class="wiz-error-msg"></label>
                        </div>

                        <p class="wpfc-bottom-note" style="margin-bottom:-10px;"><a target="_blank"
                                                                                    href="https://www.wpfastestcache.com/features/clear-cache-of-specific-urls-when-updating-or-posting/">Note:
    ...
    var WpFcCsp = {
        ...
        show_list: function () {
            ...
            jQuery.ajax({
                ...
                url: ajaxurl,
                data: {
                    "action": "wpfc_get_list_csp",
                    security: '<?php echo wp_create_nonce("wpfc-save-csp-ajax-nonce"); ?>'
                },
