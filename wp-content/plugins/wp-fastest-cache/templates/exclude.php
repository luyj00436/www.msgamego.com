    ...
    <div style="z-index: 600; border-radius: 3px;">
        <div style="font-family:Verdana,Geneva,Arial,Helvetica,sans-serif;font-size:12px;background: none repeat scroll 0px 0px rgb(255, 161, 0); z-index: 1000; position: relative; padding: 2px; border-bottom: 1px solid rgb(194, 122, 0); height: 35px; border-radius: 3px 3px 0px 0px;">
            <table width="100%" height="100%">
                ...
                <tr>
                    <td valign="middle"
                        style="vertical-align: middle; font-weight: bold; color: rgb(255, 255, 255); text-shadow: 0px 1px 1px rgba(0, 0, 0, 0.5); padding-left: 10px; font-size: 13px; cursor: move;"><?php _e("Exclude Page Wizard", "wp-fastest-cache"); ?></td>
                            ...
                            <tr>
                                <td valign="top" id="cond-list">
                                    <table width="100%" cellspacing="0" cellpadding="5" border="0"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td width="100" height="35" class="wpfc-condition-text"
                                            ...
                                            <td width="300">
                                                <div class="wpfc-exclude-rule-line-middle">
                                                    <input type="text" name="wpfc-exclude-rule-content"
                                                           style="width:289px;">
                                                    <input type="hidden" name="wpfc-exclude-rule-type"
                                                           style="width:289px;">
                                                </div>
                                            </td>
                                        </tr>
    ...
    var WpFcExcludePages = {
        ...
        save: function (callback) {
            ...
            jQuery.ajax({
                ...
                url: ajaxurl,
                data: {
                    "action": "wpfc_save_exclude_pages",
                    "rules": rules,
                    security: '<?php echo wp_create_nonce("wpfc-save-exclude-ajax-nonce"); ?>'
                },
        ...
        insert_existing_rules: function () {
            ...
            self.add_item(new Date().getTime(), {
                "type": "page",
                "prefix": "exact",
