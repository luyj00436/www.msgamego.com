<div template-id="wpfc-modal-nginxgzip"
     style="top: 10.5px; left: 226px; position: absolute; padding: 6px; height: auto; width: 360px; z-index: 10001;display:none;">
    ...
    <div style="z-index: 600; border-radius: 3px;">
        <div style="font-family:Verdana,Geneva,Arial,Helvetica,sans-serif;font-size:12px;background: none repeat scroll 0px 0px rgb(255, 161, 0); z-index: 1000; position: relative; padding: 2px; border-bottom: 1px solid rgb(194, 122, 0); height: 35px; border-radius: 3px 3px 0px 0px;">
            <table width="100%" height="100%">
                ...
                <tr>
                    <td valign="middle"
                        style="vertical-align: middle; font-weight: bold; color: rgb(255, 255, 255); text-shadow: 0px 1px 1px rgba(0, 0, 0, 0.5); padding-left: 10px; font-size: 13px; cursor: move;"><?php _e("Enable Gzip", "wp-fastest-cache"); ?></td>
            ...
            <div style="z-index: 1000; height: auto; position: relative; display: inline-block; width: 100%;"
                ...
                <div class="wpfc-cdn-pages-container">
                    <div class="wiz-cont" style="">
                        ...
                        <p>Nginx is used in the server so you need to enable the Gzip manually. Please take a look at
                        ...
                        <div class="wiz-input-cont" style="margin-top:10px !important;">
                            <label class="mc-input-label" style="margin-right: 5px;">
                                <a href="http://www.wpfastestcache.com/tutorial/how-to-enable-gzip-on-nginx/"
                                   target="_blank">http://www.wpfastestcache.com/tutorial/how-to-enable-gzip-on-nginx/</a>
                            </label>
                        </div>
                    </div>
                </div>
    ...
    jQuery("#wpFastestCacheGzip").click(function () {
        if (jQuery("#wpFastestCacheGzip").is(':checked')) {
            if (jQuery("div[id^='wpfc-modal-nginxgzip-']").length === 0) {
                Wpfc_New_Dialog.dialog("wpfc-modal-nginxgzip", {
                    close: function () {
