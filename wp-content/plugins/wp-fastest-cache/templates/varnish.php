<div template-id="wpfc-modal-varnish"
            ...
            <div style="z-index: 1000; height: auto; position: relative; display: inline-block; width: 100%;"
                ...
                <div id="wpfc-wizard-varnish" class="wpfc-cdn-pages-container">
                    <div wpfc-cdn-page="1" class="wiz-cont">
                        ...
                        <p>Specify the IP address of your varnish instance. If you do not know the ip address, you can
                            ask your hosting provider on what to set here.</p>
                        <div class="wiz-input-cont">
                            <?php
                            $datas = get_option("WpFastestCacheVarnish");
                            $ip = isset($datas["server"]) && $datas["server"] ? $datas["server"] : "127.0.0.1";
                            ?>
                            <input value="<?php echo $ip; ?>" type="text" name="server" class="api-key"
                                   style="width: 100%;">
                            <label class="wiz-error-msg"></label>
                        </div>

                        <p class="wpfc-bottom-note" style="margin-bottom:-10px;"><a target="_blank"
                                                                                    href="https://www.wpfastestcache.com/features/using-varnish-cache-with-wp-fastest-cache/">Note:
                                Please read this article to learn about this feature.</a></p>


                    </div>

                    <img style="border-radius:100px;" class="wiz-bg-img"
            ...
            Wpfc_New_Dialog.dialog("wpfc-modal-varnish", {
                close: function (e) {
                    ...
                    jQuery.ajax({
                        ...
                        url: ajaxurl,
                        data: {
                            "action": "wpfc_purgecache_varnish",
                            security: '<?php echo wp_create_nonce("wpfc-varnish-ajax-nonce"); ?>'
                        },
