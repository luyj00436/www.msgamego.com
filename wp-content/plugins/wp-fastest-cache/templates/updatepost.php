...
<div template-id="wpfc-modal-updatepost"
     style="display:none;top: 10.5px; left: 226px; position: absolute; padding: 6px; height: auto; width: 330px; z-index: 10001;">
    ...
    <div style="z-index: 600; border-radius: 3px;">
        <div style="font-family:Verdana,Geneva,Arial,Helvetica,sans-serif;font-size:12px;background: none repeat scroll 0px 0px rgb(255, 161, 0); z-index: 1000; position: relative; padding: 2px; border-bottom: 1px solid rgb(194, 122, 0); height: 35px; border-radius: 3px 3px 0px 0px;">
            <table width="100%" height="100%">
                ...
                <tr>
                    <td valign="middle"
                        style="vertical-align: middle; font-weight: bold; color: rgb(255, 255, 255); text-shadow: 0px 1px 1px rgba(0, 0, 0, 0.5); padding-left: 10px; font-size: 13px; cursor: move;"><?php _e("Update Post", "wp-fastest-cache"); ?></td>
            ...
            <div class="window-content"
                ...
                <div class="wiz-input-cont">
                    <label class="mc-input-label" style="margin-right: 5px;"><input
                                type="radio" <?php echo $wpFastestCacheUpdatePost_type_all; ?>
                                action-id="wpFastestCacheUpdatePost_type_all" id="wpFastestCacheUpdatePost_type_all"
                                name="wpFastestCacheUpdatePost_type" value="all"></label>
                    <label for="wpFastestCacheUpdatePost_type_all"><?php _e("Clear All Cache", "wp-fastest-cache"); ?></label>
                </div>
                <div class="wiz-input-cont">
                    <label class="mc-input-label" style="margin-right: 5px;"><input
                                type="radio" <?php echo $wpFastestCacheUpdatePost_type_post; ?>
                                action-id="wpFastestCacheUpdatePost_type_post" id="wpFastestCacheUpdatePost_type_post"
                                name="wpFastestCacheUpdatePost_type" value="post"></label>
                    <label for="wpFastestCacheUpdatePost_type_post"><?php _e("Clear Cache of Post / Page", "wp-fastest-cache"); ?></label><br>
                    <label style="margin-left:24px;"
                           for="wpFastestCacheUpdatePost_type_post"><?php _e("Clear Cache of Post Categories", "wp-fastest-cache"); ?></label><br>
                    <label style="margin-left:24px;"
                           for="wpFastestCacheUpdatePost_type_post"><?php _e("Clear Cache of Post Tags", "wp-fastest-cache"); ?></label><br>
                    <label style="margin-left:24px;"
                           for="wpFastestCacheUpdatePost_type_post"><?php _e("Clear Cache of Homepage", "wp-fastest-cache"); ?></label>
                </div>
    ...
    jQuery("#wpFastestCacheUpdatePost").click(function () {
        if (jQuery(this).is(':checked')) {
            if (jQuery("div[id^='wpfc-modal-updatepost-']").length === 0) {
                Wpfc_New_Dialog.dialog("wpfc-modal-updatepost", {
                    close: function () {
