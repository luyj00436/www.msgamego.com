            ...
            if (isset($_GET['sm_donated']) || ($this->sg->get_option('i_donated') === true && $this->sg->get_option('i_hide_donated') !== true)) {
                ...
                <div class='updated'>
                    <strong>
                        ...
                        <p><?php echo esc_html(str_replace('%s', esc_html($this->sg->get_redirect_link('redir/sitemap-works-note')), esc_html('Thanks for using this plugin! You\'ve installed this plugin some time ago. If it works and your are satisfied, why not ' . esc_html('<a href=\'%s\'>rate it</a>') . ' and <a href=\'%s\'>recommend it</a> to others? :-)'))); ?>
                            <a href='<?php esc_url($this->sg->get_back_link()) . '&amp;sm_hide_works=true'; ?>'
                               style='float:right; display:block; border:none;'><small
                                        style='font-weight:normal; '><?php esc_html_e('Don\'t show this me anymore', 'sitemap'); ?></small></a>
                        </p>
                    </strong>
                    <div style='clear:right;'></div>
                </div>
        ...
        <div class='wrap' id='sm_div'>
                    ...
                    <div class='inner-sidebar'>
                        <div id='side-sortables' class='meta-box-sortabless ui-sortable' style='position:relative;'>
                            ...
                            <div id='poststuff' class='metabox-holder'>
                                ...
                                <a class='sm_button'
                                   href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-home')); ?>'><?php esc_html_e('Plugin Homepage', 'sitemap'); ?></a>
                                <a class='sm_button'
                                   href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-support')); ?>'><?php esc_html_e('Suggest a Feature', 'sitemap'); ?></a>
                                <a class='sm_button'
                                   href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-help')); ?>'><?php esc_html_e('Help / FAQ', 'sitemap'); ?></a>
                                <a class='sm_button'
                                   href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-list')); ?>'><?php esc_html_e('Notify List', 'sitemap'); ?></a>
                                <a class='sm_button'
                                   href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-support')); ?>'><?php esc_html_e('Support Forum', 'sitemap'); ?></a>
                                <a class='sm_button'
                                   href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-bugs')); ?>'><?php esc_html_e('Report a Bug', 'sitemap'); ?></a>
                                <?php
                                if (__('translator_name', 'sitemap') !== 'translator_name') {
                                    ?>
                                    <a class='sm_button sm_pluginSupport'
                                       href='<?php esc_html_e('translator_url', 'sitemap'); ?>'><?php esc_html_e('translator_name', 'sitemap'); ?></a><?php } ?>
                                <?php $this->html_print_box_footer(true); ?>

                                <?php $this->html_print_box_header('sm_smres', __('Sitemap Resources:', 'sitemap'), true); ?>
                                <a class='sm_button'
                                   href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-gwt')); ?>'><?php esc_html_e('Webmaster Tools', 'sitemap'); ?></a>
                                <a class='sm_button'
                                   href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-gwb')); ?>'><?php esc_html_e('Webmaster Blog', 'sitemap'); ?></a>
                                <a class='sm_button'
                                   href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-ywb')); ?>'><?php esc_html_e('Search Blog', 'sitemap'); ?></a>
                                <a class='sm_button'
                                   href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-lwt')); ?>'><?php esc_html_e('Webmaster Tools', 'sitemap'); ?></a>
                                <a class='sm_button'
                                   href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-lswcb')); ?>'><?php esc_html_e('Webmaster Center Blog', 'sitemap'); ?></a>
                                <br/>
                                <a class='sm_button'
                                   href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-prot')); ?>'><?php esc_html_e('Sitemaps Protocol', 'sitemap'); ?></a>
                                <a class='sm_button'
                                   href='<?php echo esc_url($this->sg->get_redirect_link('projects/wordpress-plugins/google-xml-sitemaps-generator/help')); ?>'><?php esc_html_e('Official Sitemaps FAQ', 'sitemap'); ?></a>
                                <a class='sm_button'
                                   href='<?php echo esc_url($this->sg->get_redirect_link('projects/wordpress-plugins/google-xml-sitemaps-generator/help')); ?>'><?php esc_html_e('My Sitemaps FAQ', 'sitemap'); ?></a>
                                <?php $this->html_print_box_footer(true); ?>
                        ...
                        <div class='has-sidebar sm-padded'>
                            ...
                            if (!$snl) :
                                ...
                                <div class='meta-box-sortabless'>
                                            ...
                                            <?php if ($this->sg->get_option('b_ping')) : ?>
                                                <li>
                                                    Notify Search Engines about <a
                                                            href='<?php echo esc_url(wp_nonce_url($this->sg->get_back_link() . '&sm_ping_main=true', 'sitemap')); ?>'>your
                                                        sitemap </a> or <a
                                                            href='<?php echo esc_url(wp_nonce_url($this->sg->get_back_link() . '&sm_ping_main=true', 'sitemap')); ?>'>your
                                    ...
                                    <b><?php esc_html_e('Update notification:', 'sitemap'); ?></b> <a
                                            href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-help-options-ping')); ?>'><?php esc_html_e('Learn more', 'sitemap'); ?></a>
                                    <ul>
                                        <li>
                                            <input type='checkbox' id='sm_b_ping'
                                                   name='sm_b_ping' <?php echo($this->sg->get_option('b_ping') === true ? 'checked=\'checked\'' : ''); ?> />
                                        ...
                                        <li>
                                            <label for='sm_b_robots'>
                                                <input type='checkbox' id='sm_b_robots'
                                                       name='sm_b_robots' <?php echo($this->sg->get_option('b_robots') === true ? 'checked=\'checked\'' : ''); ?> />
                                    ...
                                    <?php if (is_super_admin()) : ?>
                                        ...
                                        <b><?php esc_html_e('Advanced options:', 'sitemap'); ?></b> <a
                                                href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-help-options-adv')); ?>'><?php esc_html_e('Learn more', 'sitemap'); ?></a>
                                        <ul>
                                            <li>
                                                <label for="sm_b_memory"><?php esc_html_e('Try to increase the memory limit to:', 'sitemap'); ?>
                                                    <input type="text" name="sm_b_memory" id="sm_b_memory"
                                                           style="width:40px;"
                                                           value="<?php echo esc_attr($this->sg->get_option('b_memory')); ?>"/></label>
                                                ( <?php echo esc_html(htmlspecialchars(esc_html__('e.g. \'4M\', \'16M\'', 'sitemap'))); ?>
                                                )
                                            </li>
                                            <li>
                                                <label for='sm_b_time'><?php esc_html_e('Try to increase the execution time limit to:', 'sitemap'); ?>
                                                    <input type='text' name='sm_b_time' id='sm_b_time'
                                                           style='width:40px;'
                                                           value='<?php echo esc_attr(($this->sg->get_option('b_time') === -1 ? '' : $this->sg->get_option('b_time'))); ?>'/></label>
                                                (<?php echo esc_html(htmlspecialchars(esc_html__('in seconds, e.g. \'60\' or \'0\' for unlimited', 'sitemap'))); ?>
                                                )
                                            </li>
                                            <li>
                                                <label for='sm_b_autozip'>
                                                    <input type='checkbox' id='sm_b_autozip'
                                                           name='sm_b_autozip' <?php echo($this->sg->get_option('b_autozip') === true ? 'checked=\'checked\'' : ''); ?> />
                                            ...
                                            <li>
                                                ...
                                                <label for='sm_b_style'><?php esc_html_e('Include a XSLT stylesheet:', 'sitemap'); ?>
                                                    <input <?php echo($use_def_style ? 'disabled=\'disabled\' ' : ''); ?>
                                                            type='text' name='sm_b_style' id='sm_b_style'
                                                            value='<?php echo esc_attr($this->sg->get_option('b_style')); ?>'/></label>
                                                (<?php esc_html_e('Full or relative URL to your .xsl file', 'sitemap'); ?>
                                                )
                                                <?php
                                                if ($this->sg->get_default_style()) :
                                                    ?>
                                                    <label for='sm_b_style_default'><input <?php echo($use_def_style ? 'checked=\'checked\' ' : ''); ?>
                                                                type='checkbox' id='sm_b_style_default'
                                                                name='sm_b_style_default'
                                                                onclick='document.getElementById("sm_b_style").disabled = this.checked;'/> <?php esc_html_e('Use default', 'sitemap'); ?>
                                                    </label> <?php endif; ?>
                                            </li>
                                            <li>
                                                <label for='sm_b_baseurl'><?php esc_html_e('Override the base URL of the sitemap:', 'sitemap'); ?>
                                                    <input type='text' name='sm_b_baseurl' id='sm_b_baseurl'
                                                           value='<?php echo esc_attr($this->sg->get_option('b_baseurl')); ?>'/></label><br/>
                                                <small><?php esc_html_e('Use this if your site is in a sub-directory, but you want the sitemap be located in the root. Requires .htaccess modification.', 'sitemap'); ?>
                                                    <a href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-help-options-adv-baseurl')); ?>'><?php esc_html_e('Learn more', 'sitemap'); ?></a></small>
                                            </li>
                                            <li>
                                                <label for='sm_b_sitemap_name'><?php esc_html_e('Override the file name of the sitemap:', 'sitemap'); ?>
                                                    <input type='text' name='sm_b_sitemap_name' id='sm_b_sitemap_name'
                                                           value='<?php echo esc_attr($this->sg->get_option('b_sitemap_name')); ?>'/></label><br/>
                                                <small><?php esc_html_e('Use this if you want to change the sitemap file name', 'sitemap'); ?>
                                                    <a href='<?php echo esc_url($this->sg->get_redirect_link('sitemap-help-options-adv-baseurl')); ?>'><?php esc_html_e('Learn more', 'sitemap'); ?></a></small>
                                            </li>
                                            <li>
                                                <label for='sm_i_tid'><?php esc_html_e(' Add Google Analytics TID:', 'sitemap'); ?>
                                                    <input type='text' name='sm_i_tid' id='sm_i_tid'
                                                           value='<?php echo esc_attr($this->sg->get_option('i_tid')); ?>'/></label><br/>
                                            </li>
                                            <li>
                                                <label for='sm_b_html'>
                                            ...
                                            <li>
                                                <label for='sm_b_stats'>
                                                    <input type='checkbox' id='sm_b_stats'
                                                           name='sm_b_stats' <?php echo($this->sg->get_option('b_stats') === true ? 'checked=\'checked\'' : ''); ?> />
                                                    <?php esc_html_e('Allow anonymous statistics (no personal information)', 'sitemap'); ?>
                                                </label> <label><a
                                                            href='<?php echo esc_url($this->sg->get_redirect_link('redir/sitemap-help-options-adv-stats')); ?>'><?php esc_html_e('Learn more', 'sitemap'); ?></a></label>
                                            </li>
                                        </ul>
                                    <?php endif; ?>
                                    ...
                                    ?>
                                        <table width='100%' cellpadding='3' cellspacing='3' id='sm_pageTable'>
                                            ...
                                            if (count($pages) <= 0) {
                                                ...
                                                <tr>
                                                    <td colspan='5'
                                                        align='center'><?php esc_html_e('No pages defined.', 'sitemap'); ?></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
                                        ...
                                        <a href='javascript:void(0);'
                                           onclick='sm_addPage();'><?php esc_html_e('Add new page', 'sitemap'); ?></a>
                                        <?php $this->html_print_box_footer(); ?>
                                    <?php endif; ?>
                                        ...
                                        <li>
                                            <label for='sm_in_home'>
                                                <input type='checkbox' id='sm_in_home'
                                                       name='sm_in_home' <?php echo($this->sg->get_option('in_home') === true ? 'checked=\'checked\'' : ''); ?> />
                                        ...
                                        <li>
                                            <label for='sm_in_posts'>
                                                <input type='checkbox' id='sm_in_posts'
                                                       name='sm_in_posts' <?php echo($this->sg->get_option('in_posts') === true ? 'checked=\'checked\'' : ''); ?> />
                                                <?php esc_html_e('Include posts', 'sitemap'); ?>
                                            </label>
                                        </li>
                                        <li>
                                            <label for='sm_in_product_cat'>
                                                <input type='checkbox' id='sm_in_product_cat'
                                                       name='sm_in_product_cat' <?php echo($this->sg->get_option('in_product_cat') === true ? 'checked=\'checked\'' : ''); ?> />
                                                <?php esc_html_e('Include product categories', 'sitemap'); ?>
                                            </label>
                                        </li>
                                        <li>
                                            <label for='sm_product_tags'>
                                                <input type='checkbox' id='sm_product_tags'
                                                       name='sm_product_tags' <?php echo($this->sg->get_option('product_tags') === true ? 'checked=\'checked\'' : ''); ?> />
                                        ...
                                        <li>
                                            <label for='sm_in_pages'>
                                                <input type='checkbox' id='sm_in_pages'
                                                       name='sm_in_pages' <?php echo($this->sg->get_option('in_pages') === true ? 'checked=\'checked\'' : ''); ?> />
                                        ...
                                        <li>
                                            <label for='sm_in_cats'>
                                                <input type='checkbox' id='sm_in_cats'
                                                       name='sm_in_cats' <?php echo($this->sg->get_option('in_cats') === true ? 'checked=\'checked\'' : ''); ?> />
                                        ...
                                        <li>
                                            <label for='sm_in_arch'>
                                                <input type='checkbox' id='sm_in_arch'
                                                       name='sm_in_arch' <?php echo($this->sg->get_option('in_arch') === true ? 'checked=\'checked\'' : ''); ?> />
                                        ...
                                        <li>
                                            <label for='sm_in_auth'>
                                                <input type='checkbox' id='sm_in_auth'
                                                       name='sm_in_auth' <?php echo($this->sg->get_option('in_auth') === true ? 'checked=\'checked\'' : ''); ?> />
                                            ...
                                            <li>
                                                <label for='sm_in_tags'>
                                                    <input type='checkbox' id='sm_in_tags'
                                                           name='sm_in_tags' <?php echo($this->sg->get_option('in_tags') === true ? 'checked=\'checked\'' : ''); ?> />
                                                ...
                                                foreach ($taxonomies as $tax_name) {
                                                    ...
                                                    <li>
                                                        <label for='sm_in_tax[<?php echo esc_attr($taxonomy->name); ?>]'>
                                                            <input type='checkbox'
                                                                   id='sm_in_tax[<?php echo esc_attr($taxonomy->name); ?>]'
                                                                   name='sm_in_tax[<?php echo esc_attr($taxonomy->name); ?>]' <?php echo $selected ? 'checked=\'checked\'' : ''; ?> />
                                                            <?php /* translators: %s: search term */ ?>
                                                ...
                                                foreach ($custom_post_types as $post_type) {
                                                    ...
                                                    <li>
                                                        <label for='sm_in_customtypes[<?php echo esc_html($post_type_object->name); ?>]'>
                                                            <input type='checkbox'
                                                                   id='sm_in_customtypes[<?php echo esc_html($post_type_object->name); ?>]'
                                                                   name='sm_in_customtypes[<?php echo esc_html($post_type_object->name); ?>]' <?php echo $selected ? 'checked=\'checked\'' : ''; ?> />
                                                            <?php /* translators: %s: search term */ ?>
                                        ...
                                        <li>
                                            <label for='sm_in_lastmod'>
                                                <input type='checkbox' id='sm_in_lastmod'
                                                       name='sm_in_lastmod' <?php echo($this->sg->get_option('in_lastmod') === true ? 'checked=\'checked\'' : ''); ?> />
                                    ...
                                    <ul>
                                        <li>
                                            <label for='sm_links_page'>
                                                ...
                                                <input type='number' name='sm_links_page' id='sm_links_page'
                                                       style='width:50px; margin-left:10px;'
                                                       value='<?php echo esc_attr($this->sg->get_option('links_page')); ?>'/>
                                            </label>
                                        </li>
                                    </ul>
                                    ...
                                    <div style='margin:5px 0 13px 40px;'>
                                        <label for='sm_b_exclude'><?php esc_html_e('Exclude the following posts or pages:', 'sitemap'); ?>
                                            <small><?php esc_html_e('List of IDs, separated by comma', 'sitemap'); ?></small><br/>
                                            <input name="sm_b_exclude" id="sm_b_exclude" type="text"
                                                   style="width:400px;"
                                                   value="<?php echo esc_attr(implode(',', $this->sg->get_option('b_exclude'))); ?>"/></label><br/>
                                        <cite><?php esc_html_e('Note', 'sitemap'); ?>
                                            : <?php esc_html_e('Child posts won\'t be excluded automatically!', 'sitemap'); ?></cite>
                                    </div>
                                        ...
                                        <li>
                                            <label for='sm_cf_home'>
                                                <select id='sm_cf_home'
                                                        name='sm_cf_home'><?php $this->html_get_freq_names($this->sg->get_option('cf_home')); ?></select>
                                        ...
                                        <li>
                                            <label for='sm_cf_posts'>
                                                <select id='sm_cf_posts'
                                                        name='sm_cf_posts'><?php $this->html_get_freq_names($this->sg->get_option('cf_posts')); ?></select>
                                        ...
                                        <li>
                                            <label for='sm_cf_pages'>
                                                <select id='sm_cf_pages'
                                                        name='sm_cf_pages'><?php $this->html_get_freq_names($this->sg->get_option('cf_pages')); ?></select>
                                        ...
                                        <li>
                                            <label for='sm_cf_cats'>
                                                <select id='sm_cf_cats'
                                                        name='sm_cf_cats'><?php $this->html_get_freq_names($this->sg->get_option('cf_cats')); ?></select>
                                                <?php esc_html_e('Categories', 'sitemap'); ?>
                                            </label>
                                        </li>
                                        <li>
                                            <label for='sm_cf_product_cat'>
                                                <select id='sm_cf_product_cat'
                                                        name='sm_cf_product_cat'><?php $this->html_get_freq_names($this->sg->get_option('cf_product_cat')); ?></select>
                                        ...
                                        <li>
                                            <label for='sm_cf_arch_curr'>
                                                <select id='sm_cf_arch_curr'
                                                        name='sm_cf_arch_curr'><?php $this->html_get_freq_names($this->sg->get_option('cf_arch_curr')); ?></select>
                                        ...
                                        <li>
                                            <label for='sm_cf_arch_old'>
                                                <select id='sm_cf_arch_old'
                                                        name='sm_cf_arch_old'><?php $this->html_get_freq_names($this->sg->get_option('cf_arch_old')); ?></select>
                                            ...
                                            <li>
                                                <label for='sm_cf_tags'>
                                                    <select id='sm_cf_tags'
                                                            name='sm_cf_tags'><?php $this->html_get_freq_names($this->sg->get_option('cf_tags')); ?></select>
                                        ...
                                        <li>
                                            <label for='sm_cf_auth'>
                                                <select id='sm_cf_auth'
                                                        name='sm_cf_auth'><?php $this->html_get_freq_names($this->sg->get_option('cf_auth')); ?></select>
                                        ...
                                        <li>
                                            <label for='sm_pr_home'>
                                                <select id='sm_pr_home'
                                                        name='sm_pr_home'><?php $this->html_get_priority_values($this->sg->get_option('pr_home')); ?></select>
                                                <?php esc_html_e('Homepage', 'sitemap'); ?>
                                            </label>
                                        </li>
                                        <li>
                                            ...
                                            <label for='sm_pr_posts'>
                                                <select id='sm_pr_posts'
                                                        name='sm_pr_posts'><?php $this->html_get_priority_values($this->sg->get_option('pr_posts')); ?></select>
                                        ...
                                        <li>
                                            ...
                                            <label for='sm_pr_posts_min'>
                                                <select id='sm_pr_posts_min'
                                                        name='sm_pr_posts_min'><?php $this->html_get_priority_values($this->sg->get_option('pr_posts_min')); ?></select>
                                        ...
                                        <li>
                                            ...
                                            <label for='sm_pr_pages'>
                                                <select id='sm_pr_pages'
                                                        name='sm_pr_pages'><?php $this->html_get_priority_values($this->sg->get_option('pr_pages')); ?></select>
                                                <?php esc_html_e('Static pages', 'sitemap'); ?>
                                            </label>
                                        </li>
                                        <li>
                                            <label for='sm_pr_cats'>
                                                <select id='sm_pr_cats'
                                                        name='sm_pr_cats'><?php $this->html_get_priority_values($this->sg->get_option('pr_cats')); ?></select>
                                                <?php esc_html_e('Categories', 'sitemap'); ?>
                                            </label>
                                        </li>
                                        <li>
                                            <label for='sm_pr_product_cat'>
                                                <select id='sm_pr_product_cat'
                                                        name='sm_pr_product_cat'><?php $this->html_get_priority_values($this->sg->get_option('pr_product_cat')); ?></select>
                                                <?php esc_html_e('Product Categories', 'sitemap'); ?>
                                            </label>
                                        </li>
                                        <li>
                                            <label for='sm_pr_arch'>
                                                <select id='sm_pr_arch'
                                                        name='sm_pr_arch'><?php $this->html_get_priority_values($this->sg->get_option('pr_arch')); ?></select>
                                            ...
                                            <li>
                                                <label for='sm_pr_tags'>
                                                    <select id='sm_pr_tags'
                                                            name='sm_pr_tags'><?php $this->html_get_priority_values($this->sg->get_option('pr_tags')); ?></select>
                                                    <?php esc_html_e('Tag pages', 'sitemap'); ?>
                                                </label>
                                            </li>
                                        <?php endif; ?>
                                        <li>
                                            ...
                                            <label for='sm_pr_auth'>
                                                <select id='sm_pr_auth'
                                                        name='sm_pr_auth'><?php $this->html_get_priority_values($this->sg->get_option('pr_auth')); ?></select>
                                                <?php esc_html_e('Author pages', 'sitemap'); ?>
                                            </label>
                                        </li>
                                    </ul>
                                ...
                                <div>
                                    <p class='submit'>
                                        ...
                                        <input type='submit' class='button-primary' name='sm_update'
                                               value='<?php esc_html_e('Update options', 'sitemap'); ?>'/>
                                        <input type='submit' onclick='return confirm(' Do you really want to reset your
                                               configuration?');' class='sm_warning' name='sm_reset_config'
                                        value='<?php esc_html_e('Reset options', 'sitemap'); ?>' />
                                    </p>
                                </div>
            ...
            <form action='https://www.paypal.com/cgi-bin/webscr' method='post' id='sm_donate_form'>
                ...
                <input type='hidden' name='business'
                       value='<?php echo 'xmlsitemapgen' /* N O S P A M */ . '@gmail.com'; ?>'/>
                <input type='hidden' name='item_name'
                       value='Sitemap Generator for WordPress. Please tell me if if you don' t want to be listed on the
                       donator list.' />
                <input type='hidden' name='no_shipping' value='1'/>
                <input type='hidden' name='return'
                       value='<?php echo esc_attr($this->sg->get_back_link('&sm_donated=true')); ?>'/>
