        ...
        <td>
            <?php if ($countEnhancedFolder > 0) : ?>
                <button class="button button-primary button-large njt-fb-import njt-button-loading" data-site="enhanced"
                        type="button"
                        data-count="<?php echo $countEnhancedFolder; ?>"><?php _e('Import Now', 'filebird'); ?></button>
            <?php endif; ?>
        ...
        <td>
            <?php if ($countWpmlfFolder > 0) : ?>
                <button class="button button-primary button-large njt-fb-import njt-button-loading" data-site="wpmlf"
                        type="button"
                        data-count="<?php echo $countWpmlfFolder; ?>"><?php _e('Import Now', 'filebird'); ?></button>
            <?php endif; ?>
            <p class="description" style="font-weight: 400">
                <?php
        ...
        <td>
            <?php if ($countWpmfFolder > 0) : ?>
                <button class="button button-primary button-large njt-fb-import njt-button-loading" data-site="wpmf"
                        type="button"
                        data-count="<?php echo $countWpmfFolder; ?>"><?php _e('Import Now', 'filebird'); ?></button>
            <?php endif; ?>
            <p class="description" style="font-weight: 400">
                <?php
        ...
        <td>
            <?php if ($countRealMediaFolder > 0) : ?>
                <button class="button button-primary button-large njt-fb-import njt-button-loading"
                        ...
                        data-count="<?php echo $countRealMediaFolder; ?>"><?php _e('Import Now', 'filebird'); ?></button>
            <?php endif; ?>
            <p class="description" style="font-weight: 400">
                <?php
        ...
        <td>
            <?php if ($countHappyFiles > 0) : ?>
                <button class="button button-primary button-large njt-fb-import njt-button-loading"
                        ...
                        data-count="<?php echo $countHappyFiles; ?>"><?php _e('Import Now', 'filebird'); ?></button>
            <?php endif; ?>
            <p class="description" style="font-weight: 400">
                <?php
        ...
        <td>
            <?php if ($countPremioFolder > 0) : ?>
                <button class="button button-primary button-large njt-fb-import njt-button-loading" data-site="premio"
                        type="button"
                        data-count="<?php echo $countPremioFolder; ?>"><?php _e('Import Now', 'filebird'); ?></button>
            <?php endif; ?>
            <p class="description" style="font-weight: 400">
                <?php
    ...
    <tr>
        ...
        <td>
            <div style="display: flex; align-items: center">
                ...
                <a id="njt-fb-download-csv" href="javascript:;" style="margin-left: 10px" class="hidden">Download
                    File</a>
            </div>
            <p class="description" style="font-weight: 400">
    ...
    <tr>
        ...
        <td>
            ...
            <p class="description">
                ...
                <?php echo __('(Please check to make sure that there is no duplicated name. The current folder structure is preserved.)', 'filebird'); ?>
                <br/>
            </p>
        </td>
    </tr>
