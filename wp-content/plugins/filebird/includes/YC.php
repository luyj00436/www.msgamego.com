        ...
        public function notification()
        {
            ...
            <div class="notice notice-info is-dismissible" id="njt-yc">
                <div class="njt-yc-wrapper">
                    ...
                    <p>
                        <a href="<?php echo esc_url($this->autoInstallUrl); ?>"
                           aria-label="More information about YayMail" data-title="YayMail"
                           class="button button-primary"><?php _e('Install for Free', 'filebird'); ?></a>
