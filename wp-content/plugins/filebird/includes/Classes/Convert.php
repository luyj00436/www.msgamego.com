    ...
    public function adminNotice()
    {
        ...
        foreach ($sites as $k => $site) :
            ...
            <div class="njt notice notice-warning <?php echo esc_attr($site['site']); ?> is-dismissible">
                ...
                <p>
                    <a target="_blank"
                       href="<?php echo esc_url(add_query_arg(array('page' => 'filebird-settings', 'tab' => 'import'), admin_url('options-general.php'))); ?>"
                       class="button button-primary"><?php _e('Import Now', 'filebird'); ?></a>
                    <button class="button njt_fb_no_thanks_btn"
                            data-site="<?php echo esc_attr($site['site']); ?>"><?php _e('No, thanks', 'filebird') ?></button>
                </p>
            </div>
        <?php endforeach; ?>
        <?php
