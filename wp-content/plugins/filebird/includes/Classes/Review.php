        ...
        if (function_exists('get_current_screen')) {
            if (get_current_screen()->id == 'upload' || get_current_screen()->id == 'plugins') {
                ...
                <div class="notice notice-success is-dismissible" id="njt-FileBird-review">
                    ...
                    <p>
                        <a href="javascript:;" data="rateNow" class="button button-primary"
                           style="margin-right: 5px"><?php _e('Rate now', 'filebird') ?></a>
                        <a href="javascript:;" data="later" class="button"
                           style="margin-right: 5px"><?php _e('Later', 'filebird') ?></a>
                        <a href="javascript:;" data="alreadyDid"
                           class="button"><?php _e('No, thanks', 'filebird') ?></a>
                    </p>
                </div>
                <?php
            }
