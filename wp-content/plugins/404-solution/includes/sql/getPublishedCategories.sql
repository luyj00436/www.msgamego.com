select {wp_terms}.term_id, {wp_terms}.name, {wp_terms}.slug, wp_term_taxonomy.taxonomy, wp_term_taxonomy.count, 'in code' as url
...
where ( wp_term_taxonomy.taxonomy = 'category'
   or lower ({wp_terms}.name) in ({recognizedCategories})
