...
/* this is replaced with either count(*) + start comment or with nothing. */
    ...
    wp_abj404_redirects.id, wp_abj404_redirects.url, wp_abj404_redirects.status, (CASE
    ...
    end) as status_for_view, wp_abj404_redirects.type, (CASE
    ...
    end) as type_for_view, wp_abj404_redirects.final_dest, (case
    ...
    end) as dest_for_view, wp_abj404_redirects.code, wp_abj404_redirects.timestamp, wp_posts.id as wp_post_id, {logsTableColumns}
