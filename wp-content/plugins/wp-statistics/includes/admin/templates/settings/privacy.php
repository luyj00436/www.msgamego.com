<div class="postbox">
    <table class="form-table">
        ...
        <tr valign="top">
            <td scope="row"
                colspan="2"><?php echo sprintf(__('If you want to delete visitor data, please <a href="%s">click here</a>.', 'wp-statistics'), WP_STATISTICS\Menus::admin_url('optimization', array('tab' => 'purging'))); ?></td>
        </tr>
        ...
        <tr valign="top">
            ...
            <td>
                <input id="anonymize_ips" type="checkbox" value="1"
                       name="wps_anonymize_ips" <?php echo WP_STATISTICS\Option::get('anonymize_ips') == true ? "checked='checked'" : ''; ?>>
        ...
        <tr valign="top">
            ...
            <td>
                <input id="hash_ips" type="checkbox" value="1"
                       name="wps_hash_ips" <?php echo WP_STATISTICS\Option::get('hash_ips') == true ? "checked='checked'" : ''; ?>>
        ...
        <tr valign="top">
            ...
            <td>
                <input id="store_ua" type="checkbox" value="1"
                       name="wps_store_ua" <?php echo WP_STATISTICS\Option::get('store_ua') == true ? "checked='checked'" : ''; ?>>
