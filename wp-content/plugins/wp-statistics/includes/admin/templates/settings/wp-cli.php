<div class="postbox">
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td>
                <input id="wps-wp_cli" type="checkbox" value="1"
                       name="wps_wp_cli" <?php echo WP_STATISTICS\Option::get('wp_cli') == true ? "checked='checked'" : ''; ?>>
...
<div class="postbox">
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td>
                <input id="wps-wp_cli_summary" type="checkbox" value="1"
                       name="wps_wp_cli_summary" <?php echo WP_STATISTICS\Option::get('wp_cli_summary') == true ? "checked='checked'" : ''; ?>>
        ...
        <tr valign="top">
            ...
            <td>
                <input id="wps-wp_cli_user_online" type="checkbox" value="1"
                       name="wps_wp_cli_user_online" <?php echo WP_STATISTICS\Option::get('wp_cli_user_online') == true ? "checked='checked'" : ''; ?>>
                ...
                <p class="description"><?php echo __('Show Users Online List.', 'wp-statistics'); ?><br/>
                    <?php echo __('Usage: ', 'wp-statistics'); ?> <span dir="ltr"> wp statistics online --number=[integer] </span>
                </p>
            </td>
        </tr>
        ...
        <tr valign="top">
            ...
            <td>
                <input id="wps-wp_cli_visitors" type="checkbox" value="1"
                       name="wps_wp_cli_visitors" <?php echo WP_STATISTICS\Option::get('wp_cli_visitors') == true ? "checked='checked'" : ''; ?>>
                ...
                <p class="description"><?php echo __('Show list of Visitors.', 'wp-statistics'); ?><br/>
                    <?php echo __('Usage: ', 'wp-statistics'); ?> <span dir="ltr"> wp statistics visitors --number=[integer] </span>
                </p>
            </td>
        </tr>
