        ...
        <tr valign="top">
            ...
            <td>
                <input id="wps_schedule_dbmaint" type="checkbox"
                       name="wps_schedule_dbmaint" <?php echo WP_STATISTICS\Option::get('schedule_dbmaint') == true ? "checked='checked'" : ''; ?>
                       onclick='DBMaintWarning();'>
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" class="small-text code" id="wps_schedule_dbmaint_days"
                       name="wps_schedule_dbmaint_days"
                       value="<?php echo htmlentities(WP_STATISTICS\Option::get('schedule_dbmaint_days', "365"), ENT_QUOTES); ?>"/>
        ...
        <tr valign="top">
            ...
            <td>
                <input id="wps_schedule_dbmaint_visitor" type="checkbox"
                       name="wps_schedule_dbmaint_visitor" <?php echo WP_STATISTICS\Option::get('schedule_dbmaint_visitor') == true ? "checked='checked'" : ''; ?>
                       onclick='DBMaintWarning();'>
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" class="small-text code" id="wps_schedule_dbmaint_visitor_hits"
                       name="wps_schedule_dbmaint_visitor_hits"
                       value="<?php echo htmlentities(WP_STATISTICS\Option::get('schedule_dbmaint_visitor_hits', '50'), ENT_QUOTES); ?>"/>
