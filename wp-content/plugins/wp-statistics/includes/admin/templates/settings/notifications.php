        ...
        <tr valign="top">
            ...
            <td>
                <input dir="ltr" type="text" id="email_list" name="wps_email_list" size="30"
                       value="<?php if (WP_STATISTICS\Option::get('email_list') == '') {
        ...
        <tr valign="top">
            ...
            <td>
                <input id="geoip-report" type="checkbox" value="1"
                       name="wps_geoip_report" <?php echo WP_STATISTICS\Option::get('geoip_report') == true ? "checked='checked'" : ''; ?>>
        ...
        <tr valign="top">
            ...
            <td>
                <input id="prune-report" type="checkbox" value="1"
                       name="wps_prune_report" <?php echo WP_STATISTICS\Option::get('prune_report') == true ? "checked='checked'" : ''; ?>>
    ...
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td>
                <input id="stats-report" type="checkbox" value="1"
                       name="wps_stats_report" <?php echo WP_STATISTICS\Option::get('stats_report') == true ? "checked='checked'" : ''; ?>
                       onClick='ToggleStatOptions();'>
        ...
        <tr valign="top"<?php echo $hidden; ?> id='wps_stats_report_option'>
            ...
            <td>
                ...
                <h4>Looking for chart reporting? check out <a target="_blank"
                                                              href="https://wp-statistics.com/product/wp-statistics-advanced-reporting/">Advanced
                        Reporting</a>. </h4>
            </td>
        </tr>
        </tbody>
...
<div class="postbox">
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td>
                <input id="admin-notices" type="checkbox" value="1"
                       name="wps_admin_notices" <?php echo WP_STATISTICS\Option::get('admin_notices') == true ? "checked='checked'" : ''; ?>>
