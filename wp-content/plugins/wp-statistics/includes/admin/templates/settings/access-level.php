...
<div class="postbox">
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td>
                <select dir="ltr" id="wps_read_capability"
                        name="wps_read_capability"><?php echo $option_list; ?></select>
            </td>
        </tr>
        ...
        <tr valign="top">
            ...
            <td>
                <select dir="ltr" id="wps_manage_capability"
                        name="wps_manage_capability"><?php echo $option_list; ?></select>
            </td>
        </tr>
