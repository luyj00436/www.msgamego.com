        ...
        <tr valign="top">
            ...
            <td>
                <input id="wps-exclusions" type="checkbox" value="1"
                       name="wps_record_exclusions" <?php echo WP_STATISTICS\Option::get('record_exclusions') == true ? "checked='checked'" : ''; ?>><label
                        for="wps-exclusions"><?php _e('Enable', 'wp-statistics'); ?></label>
            ...
            <tr valign="top">
                ...
                <td>
                    <input id="<?php echo $option_name; ?>" type="checkbox" value="1"
                           name="<?php echo $option_name; ?>" <?php echo WP_STATISTICS\Option::get($store_name) == true ? "checked='checked'" : ''; ?>><label
                            for="<?php echo $option_name; ?>"><?php _e('Exclude', 'wp-statistics'); ?></label>
...
<div class="postbox">
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td>
                    <textarea name="wps_robotlist" class="code textarea-input-reset" dir="ltr" rows="10" cols="60"
                              id="wps_robotlist"><?php
        ...
        <tr valign="top">
            ...
            <td>
                <input id="force_robot_update" type="checkbox" value="1"
                       name="wps_force_robot_update" <?php echo WP_STATISTICS\Option::get('force_robot_update') == true ? "checked='checked'" : ''; ?>><label
                        for="force_robot_update"><?php _e('Enable', 'wp-statistics'); ?></label>
        ...
        <tr valign="top">
            ...
            <td>
                <input id="wps_robot_threshold" type="text" size="5" name="wps_robot_threshold"
                       value="<?php echo esc_attr(WP_STATISTICS\Option::get('robot_threshold')); ?>">
        ...
        <tr valign="top">
            ...
            <td>
                <textarea id="wps_exclude_ip" name="wps_exclude_ip" rows="5" cols="60" class="code"
                          dir="ltr"><?php echo htmlentities(WP_STATISTICS\Option::get('exclude_ip'), ENT_QUOTES); ?></textarea>
                ...
                foreach (\WP_STATISTICS\IP::$private_SubNets as $ip) {
                    ...
                    <a onclick="var wps_exclude_ip = getElementById('wps_exclude_ip'); if( wps_exclude_ip != null ) { wps_exclude_ip.value = jQuery.trim( wps_exclude_ip.value + '\n<?php echo $ip; ?>' ); }"
                       class="button"><?php _e('Add', 'wp-statistics'); ?><?php echo $ip; ?></a>
                    <?php
                }
                ?>
            </td>
        ...
        <tr valign="top">
            ...
            <td>
                <input id="use_honeypot" type="checkbox" value="1"
                       name="wps_use_honeypot" <?php echo WP_STATISTICS\Option::get('use_honeypot') == true ? "checked='checked'" : ''; ?>><label
                        for="wps_use_honeypot"><?php _e('Enable', 'wp-statistics'); ?></label>
        ...
        <tr valign="top">
            ...
            <td>
                ...
                <p><input id="wps_create_honeypot" type="checkbox" value="1" name="wps_create_honeypot"> <label
        ...
        <tr valign="top">
            ...
            <td>
                <input id="corrupt_browser_info" type="checkbox" value="1"
                       name="wps_corrupt_browser_info" <?php echo WP_STATISTICS\Option::get('corrupt_browser_info') == true ? "checked='checked'" : ''; ?>><label
                        for="corrupt_browser_info"><?php _e('Enable', 'wp-statistics'); ?></label>
...
<div class="postbox">
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td>
                <textarea id="wps_excluded_countries" name="wps_excluded_countries" rows="5" cols="50" class="code"
                          dir="ltr"><?php echo htmlentities(WP_STATISTICS\Option::get('excluded_countries'), ENT_QUOTES); ?></textarea>
        ...
        <tr valign="top">
            ...
            <td>
                <textarea id="wps_included_countries" name="wps_included_countries" rows="5" cols="50" class="code"
                          dir="ltr"><?php echo htmlentities(WP_STATISTICS\Option::get('included_countries'), ENT_QUOTES); ?></textarea>
        ...
        <tr valign="top">
            ...
            <td>
                <textarea id="wps_excluded_hosts" name="wps_excluded_hosts" rows="5" cols="80" class="code"
                          dir="ltr"><?php echo htmlentities(WP_STATISTICS\Option::get('excluded_hosts'), ENT_QUOTES); ?></textarea>
                <p class="description"><?php echo __('You can add a list of fully qualified host names (i.e. server.example.com, one per line) to exclude from statistics collection.', 'wp-statistics'); ?></p>
                <br>
        ...
        <tr valign="top">
            ...
            <td>
                <input id="wps-exclude-loginpage" type="checkbox" value="1"
                       name="wps_exclude_loginpage" <?php echo WP_STATISTICS\Option::get('exclude_loginpage') == true ? "checked='checked'" : ''; ?>><label
                        for="wps-exclude-loginpage"><?php _e('Exclude', 'wp-statistics'); ?></label>
        ...
        <tr valign="top">
            ...
            <td>
                <input id="wps-exclude-feeds" type="checkbox" value="1"
                       name="wps_exclude_feeds" <?php echo WP_STATISTICS\Option::get('exclude_feeds') == true ? "checked='checked'" : ''; ?>><label
                        for="wps-exclude-feeds"><?php _e('Exclude', 'wp-statistics'); ?></label>
        ...
        <tr valign="top">
            ...
            <td>
                <input id="wps-exclude-404s" type="checkbox" value="1"
                       name="wps_exclude_404s" <?php echo WP_STATISTICS\Option::get('exclude_404s') == true ? "checked='checked'" : ''; ?>><label
                        for="wps-exclude-404s"><?php _e('Exclude', 'wp-statistics'); ?></label>
        ...
        <tr valign="top">
            ...
            <td>
                <textarea id="wps_excluded_urls" name="wps_excluded_urls" rows="5" cols="80" class="code"
                          dir="ltr"><?php echo htmlentities(WP_STATISTICS\Option::get('excluded_urls'), ENT_QUOTES); ?></textarea>
                <p class="description"><?php echo __('You can add a list of local URLs (i.e.  /wordpress/about, one per line) to exclude from statistics collection.', 'wp-statistics'); ?></p>
                <br>
