    ...
    <div class="metabox-holder">
        <div class="meta-box-sortables">
            <div class="postbox" id="<?php echo \WP_STATISTICS\Meta_Box::getMetaBoxKey('pages-chart'); ?>">
                ...
                <h2 class="hndle wps-d-inline-block"><span><?php _e('Tag Statistics Chart', 'wp-statistics'); ?></span>
                </h2>
                <div class="inside">
                    <!-- Do Js -->
                </div>
    ...
    <div class="metabox-holder">
        <div class="meta-box-sortables">
            <div class="postbox">
                ...
                <h2 class="hndle wps-d-inline-block">
                    <span><?php _e('Tag Statistics Summary', 'wp-statistics'); ?></span></h2>
                <div class="inside">
