            ...
            onclick: function () {
                editor.windowManager.open({
                    ...
                    body: [
                        {
                            ...
                            'values': [
                                ...
                                {
                                    text: editor.getLang('wp_statistic_tinymce_plugin.commentcount'),
                                    value: 'commentcount'
                                },
                                ...
                                {
                                    text: editor.getLang('wp_statistic_tinymce_plugin.commentaverage'),
                    ...
                    onsubmit: function (e) {
                        ...
                        if (e.data.time !== '0') {
                            wp_statistice_shortcode += ' time=' + e.data.time;
                        }
