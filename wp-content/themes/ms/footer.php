        ...
        <?php if (_cao('cao_copyright_text', '') != '') : ?>
            <div class="site-info">
                ...
                <?php if (_cao('cao_ipc_info')) : ?>
                    <a href="https://beian.miit.gov.cn" target="_blank" class="text"
                       rel="noreferrer nofollow"> <?php echo _cao('cao_ipc_info') ?></a>
...
<div class="rollbar">
    ...
    <?php if (_cao('is_qiandao')) : ?>
        <div class="rollbar-item tap-click-qiandao"><a class="click-qiandao" title="签到" href="javascript:;"><i
    ...
    <?php if (!_cao('is_all_publish_posts', '1')) : ?>
        <?php if ((current_user_can('contributor') || current_user_can('publish_posts')) && _cao('is_wp_admin_write', '1')) : ?>
            <div class="rollbar-item tap-pencil"><a target="_blank" title="投稿赚钱"
                                                    href="<?php echo esc_url(home_url('/wp-admin/post-new.php')); ?>"><i
...
<?php if (_cao('is_console_footer', 'true')) : ?>
    <script>
        console.log("\n %c <?php echo _the_theme_name() . ' V' . _the_theme_version();?>   \n\n", "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;");
