...
if (!function_exists('caozhuti_scripts')):
    function caozhuti_scripts()
    {
        ...
        if (!is_admin()) {
            ...
            wp_enqueue_style('app', $__f . '/css/apps.css', array(), $__v, 'all');
            ...
            wp_enqueue_style('rotation', $__f . '/css/rotation.css', array(), $__v, '');
            wp_enqueue_style('hot_game', $__f . '/css/hot_game.css', array(), $__v, '');
            wp_enqueue_style('gameinfo', $__f . '/css/gameinfo.css', array(), $__v, '');
            ...
            wp_enqueue_script('app', $__f . '/js/apps.js', array('plugins'), $__v, true);
...
//            require_once $ripro_inc_dir . '/inc/class/core.class.' . $php_v . '.php';
            require_once $ripro_inc_dir . '/inc/class/core.class.' . '7.3' . '.php';
        } else {
            wp_safe_redirect($ripro_theme_uri . '/help/swoole-compiler-loader.php');
            die;
        }
    } else {
