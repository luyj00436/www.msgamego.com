...
<div class="col-xs-12 col-sm-12 col-md-9">
    <form class="mb-0">
        <?php get_template_part('pages/user/header-card');
        ...
        <div class="form-box">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12" style=" margin-bottom: 30px; ">
                    ...
                    <span class="btn avatarinfo">
                        ...
                        <?php if (!_cao('disabled_up_ava')) { ?>
                            <a class="upload"><i class="fa fa-camera"></i><input type="file" name="addPic" id="addPic"
                                                                                 accept=".jpg, .gif, .png"
                                                                                 resetonclick="true"
                        ...
                        <input type="radio" id="type-gravatar" name="user_avatar_type"
                               value="gravatar" <?php echo $_uavtype == 'gravatar' ? 'checked' : ''; ?>><label
                                for="type-gravatar">默认</label>
                    </span>
                    <?php if (_is_bind_openid('qq')): ?>
                        ...
                        <input type="radio" id="type-qq" name="user_avatar_type"
                               value="qq" <?php echo $_uavtype == 'qq' ? 'checked' : ''; ?>><label
                                    for="type-qq">QQ</label>
                    </span>
                    <?php endif; ?>
                    <?php if (_is_bind_openid('weixin') || _is_bind_openid('mpweixin')): ?>
                        ...
                        <input type="radio" id="type-weixin" name="user_avatar_type"
                               value="weixin" <?php echo $_uavtype == 'weixin' ? 'checked' : ''; ?>><label
                                    for="type-weixin">微信</label>
                    </span>
                    <?php endif; ?>
                    <?php if (_is_bind_openid('weibo')): ?>
                        ...
                        <input type="radio" id="type-weibo" name="user_avatar_type"
                               value="weibo" <?php echo $_uavtype == 'weibo' ? 'checked' : ''; ?>><label
                                    for="type-weibo">微博</label>
                    </span>
                    <?php endif; ?>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $current_user->user_login; ?>"
                               disabled="disabled">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nickname" id="nickname"
                               value="<?php echo $current_user->nickname; ?>">
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="edit_email_cap" id="edit_email_cap"
                                       value="">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="qq" id="qq"
                               value="<?php echo get_user_meta($current_user->ID, 'qq', true) ?>">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="description" id="description"
                          rows="2"><?php echo get_user_meta($current_user->ID, 'description', true) ?></textarea>
            </div>
