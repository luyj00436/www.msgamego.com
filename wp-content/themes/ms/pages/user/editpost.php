...
<div class="col-xs-12 col-sm-12 col-md-9">
    <form class="mb-0">
        <?php if (current_user_can('publish_posts')): ?>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <label>标题*</label>
                            <input type="text" class="form-control" name="post_title" placeholder="请输入标题"
                                   value="<?php echo $post->post_title; ?>" aria-required='true' required>
                        </div>
                    </div>
                    <!-- .col-md-12 end -->
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="post_excerpt" id="post_excerpt"
                                      rows="2"><?php echo $post->post_excerpt; ?></textarea>
                        </div>
                    </div>
                    <!-- .col-md-12 end -->
                    <!-- .col-md-6 end -->
                    ...
                    <div class="hide1 col-xs-12 col-sm-4 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="cao_price" value="<?php echo $cao_price; ?>"
                                   placeholder="整数">
                        </div>
                    </div>
                    <div class="hide2 col-xs-12 col-sm-4 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="cao_vip_rate"
                                   value="<?php echo $cao_vip_rate; ?>" placeholder="0.N 等于N折">
                        </div>
                    </div>
                    <div class="hide3 col-xs-12 col-sm-4 col-md-4">
                        <div class="form-group">
                            <input type="text" class="form-control" name="cao_pwd" value="<?php echo $cao_pwd; ?>"
                                   placeholder="网盘密码或解压密码">
                        </div>
                    </div>
                    <!-- .col-md-4 end -->
                    <div class="hide4 col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="cao_downurl"
                                   value="<?php echo $cao_downurl; ?>" placeholder="文件下载地址 url">
                        </div>
                    </div>
            ...
            <div class="form-box">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-12">
                        <div id="editor_c" style="display: none;"> <?php echo $post->post_content; ?> </div>
                        <div id="editor"></div>
            ...
            <!-- .form-box end -->
            <a href="#" class="go-write_post btn btn--secondary" data-edit_id="<?php echo $post_id ?>"
               data-status="draft" data-nonce="<?php echo $wp_create_nonce; ?>">保存草稿</a>
            <a href="#" class="go-write_post btn btn--primary" data-edit_id="<?php echo $post_id ?>"
               data-status="pending" data-nonce="<?php echo $wp_create_nonce; ?>">提交审核</a>
        <?php else: ?>
            <div class="form-box">
