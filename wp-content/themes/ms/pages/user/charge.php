                ...
                <div class="col-md-12">
                    <div class="charge">
                        <div class="modules__title">
                            <h4><i class="<?php echo _cao('site_money_icon'); ?>"></i>
                                余额充值中心（充值比例：1元=<?php echo _cao('site_change_rate') . _cao('site_money_ua'); ?>
                                ）</h4>
                            <a class="btn-order" href="<?php echo esc_url(home_url('/user?action=order')) ?>"><span
                                        class="label label-success">充值记录</span></a>
                        </div>
                            ...
                            <?php if (_cao('is_alipay') || _cao('is_weixinpay') || _cao('is_payjs') || _cao('is_xunhupay') || _cao('is_xunhualipay') || _cao('is_xunhupay_ali') || _cao('is_xunhupay_wx') || _cao('is_codepay')) : $cdk_display = 'style="display: none;"'; ?>
                                <div id="yuecz">
                                    ...
                                    <div class="amounts">
                                        <ul>
                                            <li data-price="18">
                                                <p>18<?php echo _cao('site_money_ua') ?></p>
                                            </li>
                                            <li data-price="38">
                                                <p>38<?php echo _cao('site_money_ua') ?></p>
                                            </li>
                                            <li data-price="68">
                                                <p>68<?php echo _cao('site_money_ua') ?></p>
                                            </li>
                                            <li data-price="98">
                                                <p>98<?php echo _cao('site_money_ua') ?></p>
                                            </li>
                                            <li data-price="198">
                                                <p>198<?php echo _cao('site_money_ua') ?></p>
                                            </li>
                                        </ul>
                                    </div>
                                    <!-- end /.amounts -->
                                    ...
                                    <div class="custom_amount">
                                        <div class="form-group">
                                            <div class="input-group charge-form">
                                                <input type="number" name="charge_num" id="charge_num"
                                                       class="form-control"
                                                       placeholder="输入整数，最低充值<?php echo _cao('min_cahrge_num', '1') . _cao('site_money_ua'); ?>起，最高<?php echo _cao('max_cahrge_num', '1000') . _cao('site_money_ua'); ?>">
                                                <div id="rmbnum" class="input-group-btn"
                                                     data-rate="<?php echo _cao('site_change_rate') ?>">￥<b>0.00</b>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="collapse" id="collapsecdk">
                                        <div class="well">
                                            <div class="form-group mb-10">
                                                <label for="qr_weixin">卡密充值单位
                                                    / <?php echo _cao('site_money_ua') ?></label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="cdkcode" value=""
                                                           placeholder="输入12位卡密">
                                                    <span class="input-group-btn">
                                                    <button class="go-cdk btn btn--danger" type="button"
                                                            data-nonce="<?php echo wp_create_nonce('caoclick-' . $current_user->ID); ?>">使用卡密</button>
                                                  </span>
                                                </div><!-- /input-group -->
                                            </div>
                                        </div>
                ...
                <div class="row">
                        ...
                        <div class="input-group">
                            ...
                            <span class="flex-center payradio">
                                  ...
                                  <label class="" for="pay_ali">
                                    <img src="<?php echo get_template_directory_uri() . '/assets/icons/alipay.png'; ?>"
                                         height="35" class="mr-2">
                                  </label>
                            </span>
                                    </div>
                                <?php endif; ?>
                                ...
                                <span class="flex-center payradio">
                                      ...
                                      <label class="" for="pay_weixin">
                                        <img src="<?php echo get_template_directory_uri() . '/assets/icons/weixin.png'; ?>"
                                             height="35" class="mr-2">
                                      </label>
                                </span>
                                    </div>
                                ...
                                <span class="flex-center payradio">
                                      ...
                                      <label class="" for="kami">
                                        <img src="<?php echo get_template_directory_uri() . '/assets/icons/kami.png'; ?>"
                                             height="35" class="mr-2">
                                      </label>
                                </span>
                                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="input-group pull-right">
                            <button type="button" class="go-charge btn btn--secondary"
                                    data-nonce="<?php echo wp_create_nonce('caoclick-' . $current_user->ID); ?>">立即充值
                            </button>
                        </div>
                    </div>
                </div>
