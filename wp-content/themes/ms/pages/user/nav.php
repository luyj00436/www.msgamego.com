        ...
        <ul class="edit--profile-links list-unstyled mb-0">
            ...
            <?php if (_cao('is_nav_write')): ?>
                <?php if (current_user_can('publish_posts') && _cao('is_wp_admin_write', '1')) : ?>
                    <li><a target="_blank" href="<?php echo esc_url(home_url('/wp-admin/edit.php')); ?>"><i
                                    class="fa fa-file-text"></i> 我的文章</a></li>
                    <li><a target="_blank" href="<?php echo esc_url(home_url('/wp-admin/post-new.php')); ?>"><i
                                    class="fa fa-pencil"></i> 发布资源</a></li>
                <?php else : ?>
