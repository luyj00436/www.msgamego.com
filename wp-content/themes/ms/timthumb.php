...
class timthumb
{
    ...
    protected $lastBenchTime = 0;
        protected $cropTop = false; //Generally if timthumb.php is modifed (upgraded) then the salt changes and all cache files are recreated. This is a backup mechanism to force regen.
