        ...
        <div class="module category-boxes boxes2 owl">
            <?php foreach ($slugs as $cat_id) : ?>
                <div class="category-box">
                    ...
                    ///////////S CACHE ////////////////
                    if (CaoCache::is()) {
                        $_the_cache_key = 'ripro_home_catbox2_posts_' . $cat_id;
                        ...
                        $category_posts = get_posts($args); //原始输出
                    }
                    ///////////S CACHE ////////////////
                    ...
                    <a<?php echo _target_blank(); ?> class="u-permalink"
                                                     href="<?php echo esc_url(get_category_link($category->cat_ID)); ?>"></a>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
