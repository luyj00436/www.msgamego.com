    ...
    <div class="register-login-modal" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <img class="popup-logo" src="<?php echo esc_url(_cao('site_logo_dark')); ?>"
                     data-dark="<?php echo esc_url(_cao('site_logo')); ?>"
                        ...
                        <div class="signup-form-container text-center">
                            <form class="mb-0">
                                ...
                                <?php } else { ?>
                                    ...
                                    <button type="button" class="go-login btn btn--primary btn--block"><i
                                                class="fa fa-bullseye"></i> 安全登录
                                    </button>
                ...
                <a target="_blank" href="<?php echo esc_url(home_url('dl?action=lostpassword')); ?>"
                   class="rest-password">忘记密码？</a>
            </div>
            <!-- /.modal-content -->
        </div>
        <!-- /.modal-dialog -->
