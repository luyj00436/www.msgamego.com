$(document).ready(function () {
    ...
    $(".gradual-show-item-boxsj:first").addClass("cur-item");
    ...
    function slider(document) {
        ...
        $(".gradual-show-item-boxsj").removeClass("cur-item");
        $(".gradual-show-item-boxsj[data-index=" + index + "]").addClass("cur-item");
    }
    ...
    function slider_autoplay() {
        //获取图片长度
        var len = $(".gradual-show-item-boxsj").length;
        if (len === 1) {
            return
        }
        //自动播放定时
        var index = $('.gradual-show-item-boxsj.cur-item').index() + 1;
