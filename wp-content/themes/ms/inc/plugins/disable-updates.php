 ...
 */
class CAO_OS_Disable_WordPress_Updates
{
    /**
...
if (class_exists('CAO_OS_Disable_WordPress_Updates')) {
    $CAO_OS_Disable_WordPress_Updates = new CAO_OS_Disable_WordPress_Updates();
}
?>