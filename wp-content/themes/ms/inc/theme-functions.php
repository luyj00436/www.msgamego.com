    ...
    <div class="entry-meta">
        ...
        if ($categories && $options['category']) : ?>
            ...
            <?php foreach ($categories as $key => $category) :
                ...
                ?>
                <a<?php echo _target_blank(); ?> href="<?php echo esc_url(get_category_link($category->term_id)); ?>"
                                                 rel="category">
        ...
        <div class="entry-media">
            <div class="placeholder" style="padding-bottom: <?php echo esc_attr($ratio); ?>;">
                <a<?php echo _target_blank(); ?> href="<?php echo esc_url(get_permalink()); ?>">
                    <img class="lazyload" data-src="<?php echo esc_url(_get_post_timthumb_src()); ?>"
                         src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
                         alt="<?php echo get_the_title(); ?>">
                </a>
                <?php if (_cao('post_tim_rload', '0')) { ?>
                    <div class="cao-cover"><img
                                src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/rings.svg" width="50"
                                height="50px"></div>
                <?php } ?>
            </div>
...
function cao_comment($comment, $args, $depth)
{
    ...
    <?php else : ?>
        ...
        <article id="div-comment-<?php comment_ID(); ?>" class="comment-wrapper u-clearfix" itemscope
    ...
    <div class="cao-pagination pagination-area">
        <nav aria-label="Page navigation">
            <ul class="pagination cao-pagination">
                <!-- <li><span>共<?php //echo $total_count;
                ?>条</span></li> -->
                <li>
