...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        array(
            ...
            'title' => '游戏介绍页背景',
            'dsec' => '',
            'default' => get_template_directory_uri() . '/assets/images/gamebg.jpg',
        ),
        array(
...
foreach ($ripro_ads_opt as $slug => $name) {
    ...
    $ripro_ads_opt_c[] = array(
        ...
        'type' => 'code_editor',
        'title' => '电脑端广告代码',
        'default' => '<a href="/" target="_blank"><img src="' . get_template_directory_uri() . '/assets/images/hero/ads.jpg" style=" width: 100%; margin: 20px 0; text-align: center; "></a>',
        'sanitize' => false,
...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type' => 'textarea',
            'title' => '底部快速搜索下文字',
            'default' => '本站由<a href="/" target="_blank" rel="noreferrer nofollow">RiPro主题</a>强力驱动',
            'dependency' => array('is_diy_footer', '==', 'true'),
        ),
        ...
        array(
            ...
            'title' => '底部版权信息',
            'subtitle' => '自定义版权信息',
            'default' => '© 2018 Theme by - <a href="/" target="_blank" rel="noreferrer nofollow">RiPro主题</a> &amp; WordPress Theme. All rights reserved',
        ),
...
//             'type'  => 'text',
//             'title' => '会员ID',
//             'after' => '<p><b><font color="red">注意本主题已破解，这里不需要填了 </font></b>如需购买正版请联系 <a href="/shangche?aff=3793
...
//             'type'  => 'text',
//             'title' => '授权码',
//             'after' => '<p><b><font color="red">注意本主题已破解，这里不需要填了</font></b> 如需购买正版请正版联系<a href="/shangche?aff=3793
// " target="_blank"> RI-VIP官网</a></p>',
//             'attributes'  => array(
//                 'type'      => 'password',
//                 'autocomplete' => 'off',
