...
//     'title'     => '<span class="badge badge-radius badge-primary"><i class="fa fa-codiepie"></i> 文章内容布局</span> ',
//     'post_type' => 'post',
...
//游戏信息
$_cao_post_game = '_cao_post_game';

CSF::createMetabox($_cao_post_game, array(
    'title' => '<span class="badge badge-radius badge-primary"><i class="fa fa-codiepie"></i> 游戏信息</span>',
    'post_type' => 'post',
    'data_type' => 'unserialize',
    'priority' => 'high',
));
...
CSF::createSection($_cao_post_game, array(
    'fields' => array(
...
if (!_cao('close_site_shop', '0')) {
    ...
    CSF::createMetabox($prefix_post_opts, array(
        'title' => '<span class="badge badge-radius badge-primary"><i class="fa fa-codiepie"></i> 付费资源信息设置</span> ',
        'post_type' => 'post',
        'data_type' => 'unserialize',
        'priority' => 'high',
    ));
...
CSF::createMetabox($prefix_post_opts_video, array(
    'title' => '<span class="badge badge-radius badge-primary"><i class="fa fa-codiepie"></i> 付费视频模块</span> ',
    'post_type' => 'post',
    'data_type' => 'unserialize',
    // 'context' => 'side',
));
