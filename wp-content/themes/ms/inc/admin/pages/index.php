                            ...
                            <div class="layui-col-sm6 layui-col-md4 layui-bg-gray">
                                <div class="layui-card">
                                    <div class="layui-card-header">
                                        <span class="layui-badge-dot layui-bg-orange"></span> <?php echo $item['name']; ?>
                                        已付款</span>
                                    ...
                                    <div class="layui-card-body layuiadmin-card-list">
                                        ...
                                        <p>订单总数 <span class="layui-badge-rim"><?php echo $_count; ?>条</span>
                                            ...
                                            <span class="layuiadmin-span-color"><span class="layui-badge-dot"></span> 订单总额 <span
                                                        class="layui-badge-rim">￥<?php echo $_sum; ?></span></span></p>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
                            ...
                            <ul class="layui-row layui-col-space10 layui-this">
                                <li class="layui-col-xs6">
                                    <a lay-href="app/content/comment.html" class="layadmin-backlog-body">
                                        <h3>文章总数</h3>
                                        <p><?php $count_posts = wp_count_posts();
                                            echo $published_posts = $count_posts->publish; ?></p>
                                    </a>
                                </li>
                                <li class="layui-col-xs6">
                                    <a lay-href="app/content/comment.html" class="layadmin-backlog-body">
                                ...
                                <li class="layui-col-xs6">
                                    <a lay-href="app/forum/list.html" class="layadmin-backlog-body">
                                        <h3>用户总数</h3>
                                        <p><?php $users = $wpdb->get_var("SELECT COUNT(ID) FROM $wpdb->users");
                                            echo $users; ?></p>
                                    </a>
                                </li>
                                <li class="layui-col-xs6">
                    ...
                    <dl class="layuiadmin-card-status">
                        ...
                        if ($result) {
                            foreach ($result as $item) {
                                ...
                                <dd>
                                    <div><p><?php echo $user_loginname ?> ： <?php echo $item->note ?></p>
                                        <span><?php echo date('Y-m-d H:i:s', $item->time) ?></span></div>
                                </dd>
                            <?php }
                        } ?>
                    </dl>
