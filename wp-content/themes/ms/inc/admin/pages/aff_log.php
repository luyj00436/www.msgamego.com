            ...
            <div class="wp-filter">
                <div class="filter-items">
                    ...
                    <div class="actions">
                        ...
                        <input class="button" id="post-query-submit" name="filter_action" type="submit"
                               value="筛选"></input>
                    </div>
                </div>
                <div class="search-form">
                    <span class="">共<?php echo $total ?>个项目 </span>
                    <input class="search" id="media-search-input" name="user_id" placeholder="根据用户搜索,回车确定…"
                           type="search" value=""/>
                </div>
                <br class="clear">
            </div>
                            ...
                            <fieldset>
                                <table class="form-table editcomment">
                                    ...
                                    <tr>
                                        ...
                                        <td><input id="user_id" name="user_id" size="30" type="text"
                                                   value="<?php echo get_user_by('id', $info->user_id)->user_login ?>"
                                                   disabled/></td>
                                    </tr>
                                    <tr>
                                        <td class="first"><label for="create_time">申请时间</label></td>
                                        <td><input id="create_time" name="create_time" size="30" type="text"
                                                   value="<?php echo date('Y-m-d H:i:s', $info->create_time) ?>"
                                                   disabled/></td>
                                    </tr>
                                    <tr>
                                        <td class="first"><label for="money">提现金额/￥</label></td>
                                        <td><input id="money" name="money" size="30" type="text"
                                                   value="<?php echo $info->money ?>" disabled/></td>
                                    </tr>
                                    <tr>
                                        <?php $up_time = ($info->up_time > 0) ? date('Y-m-d H:i:s', $info->up_time) : '——'; ?>
                                        <td class="first"><label for="up_time">审核时间</label></td>
                                        <td><input id="up_time" name="up_time" size="30" type="text"
                                                   value="<?php echo $up_time ?>" disabled/></td>
                                    </tr>
                                    <tr>
                                        <td class="first"><label for="note">提现说明</label></td>
                                        <td><input id="note" name="note" size="30" type="text"
                                                   value="<?php echo $info->note ?>" disabled/></td>
                                    </tr>
                                ...
                                <div id="minor-publishing">
                                    <div id="misc-publishing-actions">
                                        <fieldset class="misc-pub-section misc-pub-comment-status"
                                            ...
                                            <label><input <?php echo $checked = ($info->status == 0) ? 'checked="checked"' : ''; ?>
                                                        name="status" type="radio" value="0">未打款</input></label>
                                            <br>
                                            <label><input <?php echo $checked = ($info->status == 1) ? 'checked="checked"' : ''; ?>
                                                        name="status" type="radio" value="1">已打款</input></label>
                                            <br>
                                            <label><input <?php echo $checked = ($info->status == -1) ? 'checked="checked"' : ''; ?>
                                                        name="status" type="radio" value="-1">失效</input></label>
                                            <br>
                                        </fieldset>
                                    </div>
                                    <!-- misc actions -->
                                ...
                                <div id="major-publishing-actions">
                                    <div id="delete-action">
                                        <a class="submitdelete deletion"
                                           onclick="javascript:alert('为保证订单数据正常，不建议删除');">删除</a>
                                    </div>
                                    <div id="publishing-action">
                                        <input class="button button-primary button-large" id="save" name="save"
