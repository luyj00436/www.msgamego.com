        ...
        <form id="order-filter" method="get">
            ...
            <div class="wp-filter">
                ...
                <div class="search-form">
                    ...
                    <input class="search" id="media-search-input" name="code" placeholder="输入卡密搜索,回车确定…"
                           type="search" value=""/>
                </div>
                <br class="clear">
            </div>
        ...
        <form action="" id="poststuff" method="post" name="post">
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td><input class="small-text" id="num" min="1" name="num" step="1" type="number" value="1">
                        个</input></td>
                </tr>
                <tr>
                    <th scope="row"><label for="day">卡密有效期/天</label></th>
                    <td><input class="small-text" id="day" min="1" name="day" step="1" type="number" value="1">
                        天</input></td>
                </tr>
                <tr>
                    <th scope="row"><label for="sale_money">卡密金额</label></th>
                    <td><input id="sale_money" min="1" name="sale_money" step="1" type="number"
                               value="1"> <?php echo _cao('site_money_ua') ?></input></td>
                </tr>
                </tbody>
            </table>
