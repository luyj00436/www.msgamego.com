...
<div class="wrap">
    <h1>批量修改资源文章价格</h1>
    <p style=" color: #ffffff; padding: 20px; background: #FF5722; margin-top: 20px; ">
        提示：该操作不可逆转的修改所有文章的价格，修改只对已经设置过价格的文章有效，未设置过的文章没有价格和折扣字段，不能修改，只能修改，不能统一设置</p>
    <!-- <form id="poststuff"> -->
    <form action="" id="editprice" method="post" name="post">
        ...
        <table class="form-table">
            ...
            <tr>
                <th scope="row"><label for="rate">文章资源会员折扣/小数<p>【0.N 等于N折；1 等于不打折；0 等于免费】</p>
                    </label></th>
        ...
        <p class="submit"><input type="submit" name="submit" id="submit" class="button button-primary" value="批量修改">
        </p>
    </form>
</div>