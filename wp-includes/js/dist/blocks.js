        ...
        function blockStyles() {
            ...
            switch (action.type) {
                case 'ADD_BLOCK_TYPES':
                    return {
                        ...state,
                        ...(0, external_lodash_namespaceObject.mapValues)(keyBlockTypesByName(action.blockTypes), blockType => getUniqueItemsByName([...(0, external_lodash_namespaceObject.get)(blockType, ['styles'], []).map(style => ({
                            ...style,
                            source: 'block'
                ...
                case 'ADD_BLOCK_TYPES':
                    return {
                        ...
                        ...(0, external_lodash_namespaceObject.mapValues)(keyBlockTypesByName(action.blockTypes), blockType => {
                            return getUniqueItemsByName([...(0, external_lodash_namespaceObject.get)(blockType, ['variations'], []).map(variation => ({
                                ...variation,
                                source: 'block'
 ...
 */
        ...
        function getBlockProps() {
            ...
            return (0, external_wp_hooks_namespaceObject.applyFilters)('blocks.getSaveContent.extraProps', {
                ...props
