...
// generators (like Math.random()).
        ...
        function receiveEntityRecords(kind, name, records, query) {
            ...
            // on the server.
            if (kind === 'postType') {
                records = (0, external_lodash_namespaceObject.castArray)(records).map(record => record.status === 'auto-draft' ? {
                    ...record,
                    title: ''
                } : record);
            }
        ...
        /* harmony default export */
        var get_normalized_comma_separable = (getNormalizedCommaSeparable);
...
// reducer tracks only a single query object.
        ...
        /* harmony default export */
        var build_module_reducer = ((0, external_wp_data_namespaceObject.combineReducers)({
            terms,
            users,
            currentTheme,
...
// EXTERNAL MODULE: ./node_modules/equivalent-key-map/equivalent-key-map.js
        ...
        /* harmony default export */
        var forward_resolver = (forwardResolver);
        ...
        /* harmony default export */
        var _experimental_fetch_link_suggestions = (fetchLinkSuggestions);
        ...
        /* harmony default export */
        var _experimental_fetch_url_data = (fetchUrlData);
