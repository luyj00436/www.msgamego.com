...
// EXPORTS
    ...
    function moveFeaturePreferences(state, sourceStoreName) {
        var _state$interfaceStore, _state$interfaceStore2, _state$interfaceStore3, _state$sourceStoreNam,
            _state$sourceStoreNam2, _state$preferencesSto;
    ...
    function moveThirdPartyFeaturePreferencesToPreferences(state) {
        ...
        return interfaceScopeKeys.reduce(function (convertedState, scope) {
            var _convertedState$prefe, _convertedState$prefe2, _convertedState$prefe3, _convertedState$inter,
    ...
    function moveIndividualPreferenceToPreferences(state, _ref, key) {
        var _state$sourceStoreNam, _state$sourceStoreNam2, _state$preferencesSto, _state$preferencesSto2,
            _state$preferencesSto3, _state$preferencesSto4, _state$preferencesSto5, _state$preferencesSto6,
    ...
    function moveInterfaceEnableItems(state) {
        var _state$interfaceStore, _state$preferencesSto, _state$preferencesSto2, _sourceEnableItems$si,
            _sourceEnableItems$si2, _sourceEnableItems$mu, _sourceEnableItems$mu2;
