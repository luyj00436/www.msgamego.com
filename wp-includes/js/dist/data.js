...
// EXTERNAL MODULE: ./node_modules/equivalent-key-map/equivalent-key-map.js
        ...
        var promise_middleware = (promiseMiddleware);
        ...
        /* harmony default export */
        var resolvers_cache_middleware = (createResolversCacheMiddleware);
        ...
        /* harmony default export */
        var metadata_reducer = (isResolved);
            ...
            return {
                ...
                instantiate: registry => {
                    ...
                    let selectors = mapSelectors({
                        ...(0, external_lodash_namespaceObject.mapValues)(selectors_namespaceObject, selector => function (state) {
                            for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
                                args[_key - 1] = arguments[_key];
                            }
 ...
 */
        ...
        /* harmony default export */
        var persistence = (persistencePlugin);
        ...
        /* harmony default export */
        var use_dispatch_with_map = (useDispatchWithMap);
        ...
        /* harmony default export */
        var with_dispatch = (withDispatch);
