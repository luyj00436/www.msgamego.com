...
// we'd be able to replace this with a register call.
        ...
        const selectors_getWidgets = (0, external_wp_data_namespaceObject.createRegistrySelector)(select => () => {
            ...
            return (// Key widgets by their ID.
                (widgets === null || widgets === void 0 ? void 0 : widgets.reduce((allWidgets, widget) => ({
                    ...allWidgets,
                    [widget.id]: widget
                }), {})) || {}
            );
...
// bound to fail anyway.
        ...
        /* harmony default export */
        var use_is_dragging_within = (useIsDraggingWithin);
        ...
        /* harmony default export */
        var use_last_selected_widget_area = (useLastSelectedWidgetArea);
        ...
        /* harmony default export */
        var block_default = (blockDefault);
...
// for backwards compatibility.
    ...
    characters. */
        ...
        /* harmony default export */
        var use_widget_library_insertion_point = (useWidgetLibraryInsertionPoint);
        ...
        /* harmony default export */
        var layout_interface = (Interface);
